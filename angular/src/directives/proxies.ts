...
@ProxyCmp({ inputs: ["color", "disabled", "expand", "mode", "readonly", "value"] })
@Component({ selector: "ion-accordion", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["color", "disabled", "expand", "mode", "readonly", "value"] })
