...
@Component({ selector: 'ion-header', changeDetection: 0, template: '<ng-content></ng-content>', inputs: ['mode', 'collapse', 'translucent'] })
...
proxyInputs(IonHeader, ['mode', 'collapse', 'translucent']);
...
@Component({ selector: 'ion-title', changeDetection: 0, template: '<ng-content></ng-content>', inputs: ['color', 'size'] })
