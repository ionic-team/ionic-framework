...
@Component({ selector: 'ion-select-option', changeDetection: 0, template: '<ng-content></ng-content>', inputs: ['disabled', 'selected', 'value', 'class'] })
...
proxyInputs(IonSelectOption, ['disabled', 'selected', 'value', 'class']);
