...
@ProxyCmp({ inputs: ["autoHide", "color", "disabled", "icon", "menu", "mode", "type"] })
@Component({ selector: "ion-menu-button", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["autoHide", "color", "disabled", "icon", "menu", "mode", "type"] })
