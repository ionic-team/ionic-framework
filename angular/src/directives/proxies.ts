...
@ProxyCmp({
  inputs: ['cancelText', 'color', 'compareWith', 'disabled', 'fill', 'interface', 'interfaceOptions', 'justify', 'label', 'labelPlacement', 'legacy', 'mode', 'multiple', 'name', 'okText', 'placeholder', 'selectedText', 'shape', 'toggleIcon', 'toggleIconWhenOpen', 'value'],
  methods: ['open']
})
@Component({
  selector: 'ion-select',
