...
export { RouterLinkDelegateDirective as RouterLinkDelegate, RouterLinkWithHrefDelegateDirective as RouterLinkDelegateWithHref } from './directives/navigation/router-link-delegate';
