...
export { RouterLinkDelegateDirective as RouterLinkDelegate, RouterLinkDelegateDirectiveWithHref as RouterLinkDelegateWithHref } from './directives/navigation/router-link-delegate';
