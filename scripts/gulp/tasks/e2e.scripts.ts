...
function runAppScripts(folderInfo: any) {
  console.log('Running app scripts with', folderInfo.componentName);
...
function e2eComponentsExists(folderInfo: any): boolean {
  let componentPath = DIST_E2E_ROOT;
