...
export const DIST_BUILD_UMD_BUNDLE_ENTRYPOINT = join(DIST_BUILD_UMD_ROOT, INDEX_JS);
export const DIST_BUILD_ES5_ROOT = join(DIST_BUILD_ROOT, 'es5');
export const DIST_BUILD_ES2015_ROOT = join(DIST_BUILD_ROOT, 'es2015');
export const DIST_BUILD_ES5_FESM_ROOT = join(DIST_BUILD_ROOT, 'es5-fesm');
export const DIST_BUILD_ES2015_FESM_ROOT = join(DIST_BUILD_ROOT, 'es2015-fesm');
