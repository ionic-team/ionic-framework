...
class _View_E2EPage0 extends import81.AppView<import1.E2EPage> {
  ...
  _Button_84_4:import90.Button;
  _text_85:any;
  _text_86:any;
  _el_87:any;
  private _appEl_87:import82.AppElement;
  _Button_87_4:import90.Button;
  _text_88:any;
  _text_89:any;
  _text_90:any;
  _text_91:any;
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    var compView_51:any = import98.viewFactory_Button0(this.viewUtils,this.injector(51),this._appEl_51);
    this._Button_51_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_51),this.renderer);
    ...
    var compView_57:any = import98.viewFactory_Button0(this.viewUtils,this.injector(57),this._appEl_57);
    this._Button_57_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_57),this.renderer);
    ...
    var compView_60:any = import98.viewFactory_Button0(this.viewUtils,this.injector(60),this._appEl_60);
    this._Button_60_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_60),this.renderer);
    ...
    var compView_66:any = import98.viewFactory_Button0(this.viewUtils,this.injector(66),this._appEl_66);
    this._Button_66_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_66),this.renderer);
    ...
    this._appEl_75 = new import82.AppElement(75,73,this,this._el_75);
    var compView_75:any = import98.viewFactory_Button0(this.viewUtils,this.injector(75),this._appEl_75);
    this._Button_75_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_75),this.renderer);
    ...
    this._appEl_78 = new import82.AppElement(78,73,this,this._el_78);
    var compView_78:any = import98.viewFactory_Button0(this.viewUtils,this.injector(78),this._appEl_78);
    this._Button_78_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_78),this.renderer);
    ...
    var compView_84:any = import98.viewFactory_Button0(this.viewUtils,this.injector(84),this._appEl_84);
    this._Button_84_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_84),this.renderer);
    ...
    var compView_87:any = import98.viewFactory_Button0(this.viewUtils,this.injector(87),this._appEl_87);
    this._Button_87_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_87),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import90.Button) && ((57 <= requestNodeIndex) && (requestNodeIndex <= 58)))) { return this._Button_57_4; }
    ...
    if (((token === import90.Button) && ((75 <= requestNodeIndex) && (requestNodeIndex <= 76)))) { return this._Button_75_4; }
    if (((token === import90.Button) && ((78 <= requestNodeIndex) && (requestNodeIndex <= 79)))) { return this._Button_78_4; }
    if (((token === import90.Button) && ((84 <= requestNodeIndex) && (requestNodeIndex <= 85)))) { return this._Button_84_4; }
    if (((token === import90.Button) && ((87 <= requestNodeIndex) && (requestNodeIndex <= 88)))) { return this._Button_87_4; }
    if (((token === import89.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 91)))) { return this._Content_9_4; }
    return notFoundResult;
  }
...
export function viewFactory_E2EPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EPage> {
  if ((renderType_E2EPage === null)) { (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/grid/test/alignment/main.html',0,import99.ViewEncapsulation.Emulated,styles_E2EPage,{})); }
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/grid/test/alignment/AppModule.ts class E2EApp - inline template',0,import99.ViewEncapsulation.None,styles_E2EApp,{})); }
