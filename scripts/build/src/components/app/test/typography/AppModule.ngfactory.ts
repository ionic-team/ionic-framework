...
class _View_E2EApp_Host0 extends import81.AppView<any> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._E2EApp_0_4 = new import1.E2EApp(this.parentInjector.get(import9.App));
...
class _View_E2EApp0 extends import81.AppView<import1.E2EApp> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._Icon_43_3 = new import90.Icon(this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_43),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import90.Icon) && (43 === requestNodeIndex))) { return this._Icon_43_3; }
    if (((token === import89.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 45)))) { return this._Content_9_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_3:any = this._Icon_43_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_3,currVal_3)) {
      this.renderer.setElementClass(this._el_43,'hide',currVal_3);
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/app/test/typography/main.html',0,import98.ViewEncapsulation.None,styles_E2EApp,{})); }
