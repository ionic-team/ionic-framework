...
import * as import90 from '../../scroll';
...
import * as import98 from '../../scroll.ngfactory';
...
class _View_E2EApp0 extends import81.AppView<import1.E2EApp> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    var compView_14:any = import98.viewFactory_Scroll0(this.viewUtils,this.injector(14),this._appEl_14);
    this._Scroll_14_4 = new import90.Scroll(new import93.ElementRef(this._el_14));
    ...
    var compView_22:any = import98.viewFactory_Scroll0(this.viewUtils,this.injector(22),this._appEl_22);
    this._Scroll_22_4 = new import90.Scroll(new import93.ElementRef(this._el_22));
    ...
    var compView_30:any = import98.viewFactory_Scroll0(this.viewUtils,this.injector(30),this._appEl_30);
    this._Scroll_30_4 = new import90.Scroll(new import93.ElementRef(this._el_30));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import90.Scroll) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._Scroll_14_4; }
    if (((token === import90.Scroll) && ((22 <= requestNodeIndex) && (requestNodeIndex <= 25)))) { return this._Scroll_22_4; }
    if (((token === import90.Scroll) && ((30 <= requestNodeIndex) && (requestNodeIndex <= 33)))) { return this._Scroll_30_4; }
    if (((token === import89.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 34)))) { return this._Content_9_4; }
    return notFoundResult;
  }
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/scroll/test/basic/main.html',0,import99.ViewEncapsulation.Emulated,styles_E2EApp,{})); }
