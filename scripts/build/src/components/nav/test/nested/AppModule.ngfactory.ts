...
import * as import94 from '../../../navbar/navbar.ngfactory';
...
import * as import102 from '../../../menu/menu';
import * as import103 from '../../../list/list';
import * as import104 from '../../../item/item';
import * as import105 from '../../nav';
import * as import106 from '../../../menu/menu.ngfactory';
import * as import107 from '../../../toolbar/toolbar.ngfactory';
import * as import108 from '../../../item/item.ngfactory';
import * as import109 from '../../nav.ngfactory';
...
import * as import112 from '../../../menu/menu-toggle';
...
var renderType_Login_Host:import80.RenderComponentType = null;
class _View_Login_Host0 extends import81.AppView<any> {
  _el_0:any;
  ...
  constructor(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement) {
    super(_View_Login_Host0,renderType_Login_Host,import84.ViewType.HOST,viewUtils,parentInjector,declarationEl,import85.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._Login_0_4 = new import1.Login(this.parentInjector.get(import86.NavController),this.parentInjector.get(import9.App));
...
function viewFactory_Login_Host0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<any> {
...
export const LoginNgFactory:import87.ComponentFactory<import1.Login> = new import87.ComponentFactory<import1.Login>('ng-component',viewFactory_Login_Host0,import1.Login);
const styles_Login:any[] = [];
var renderType_Login:import80.RenderComponentType = null;
class _View_Login0 extends import81.AppView<import1.Login> {
  _text_0:any;
  _el_1:any;
  ...
  private _expr_2:any;
  constructor(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement) {
    super(_View_Login0,renderType_Login,import84.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import85.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import82.AppElement {
    const parentRenderNode:any = this.renderer.createViewRoot(this.declarationAppElement.nativeElement);
    this._text_0 = this.renderer.createText(parentRenderNode,'\n    ',null);
    this._el_1 = this.renderer.createElement(parentRenderNode,'ion-header',null);
    this._Header_1_3 = new import88.Header(this.parentInjector.get(import93.ViewController,null));
    ...
    var compView_3:any = import94.viewFactory_Navbar0(this.viewUtils,this.injector(3),this._appEl_3);
    this._Navbar_3_4 = new import89.Navbar(this.parentInjector.get(import9.App),this.parentInjector.get(import93.ViewController,null),this.parentInjector.get(import86.NavController,null),new import95.ElementRef(this._el_3),this.parentInjector.get(import66.Config),this.renderer);
    ...
    this._ToolbarTitle_5_4 = new import90.ToolbarTitle(new import95.ElementRef(this._el_5),this.parentInjector.get(import88.Toolbar,null),this._Navbar_3_4);
    ...
    this._Content_10_4 = new import91.Content(new import95.ElementRef(this._el_10),this.parentInjector.get(import66.Config),this.parentInjector.get(import9.App),this.parentInjector.get(import35.Keyboard),this.parentInjector.get(import58.NgZone),this.parentInjector.get(import93.ViewController,null),this.parentInjector.get(import98.Tabs,null));
    ...
    this._appEl_13 = new import82.AppElement(13,12,this,this._el_13);
    var compView_13:any = import99.viewFactory_Button0(this.viewUtils,this.injector(13),this._appEl_13);
    this._Button_13_4 = new import92.Button('',this.parentInjector.get(import66.Config),new import95.ElementRef(this._el_13),this.renderer);
    ...
    this._appEl_17 = new import82.AppElement(17,16,this,this._el_17);
    var compView_17:any = import99.viewFactory_Button0(this.viewUtils,this.injector(17),this._appEl_17);
    this._Button_17_4 = new import92.Button('',this.parentInjector.get(import66.Config),new import95.ElementRef(this._el_17),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import92.Button) && ((17 <= requestNodeIndex) && (requestNodeIndex <= 18)))) { return this._Button_17_4; }
    if (((token === import91.Content) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 19)))) { return this._Content_10_4; }
    return notFoundResult;
  }
...
export function viewFactory_Login0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.Login> {
  if ((renderType_Login === null)) { (renderType_Login = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/nav/test/nested/AppModule.ts class Login - inline template',0,import100.ViewEncapsulation.None,styles_Login,{})); }
  return new _View_Login0(viewUtils,parentInjector,declarationEl);
}
var renderType_Account_Host:import80.RenderComponentType = null;
class _View_Account_Host0 extends import81.AppView<any> {
  _el_0:any;
  private _appEl_0:import82.AppElement;
  _Account_0_4:import1.Account;
  constructor(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement) {
    super(_View_Account_Host0,renderType_Account_Host,import84.ViewType.HOST,viewUtils,parentInjector,declarationEl,import85.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import82.AppElement {
    this._el_0 = this.selectOrCreateHostElement('ng-component',rootSelector,null);
    this._appEl_0 = new import82.AppElement(0,null,this,this._el_0);
    var compView_0:any = viewFactory_Account0(this.viewUtils,this.injector(0),this._appEl_0);
    this._Account_0_4 = new import1.Account(this.parentInjector.get(import37.MenuController),this.parentInjector.get(import9.App));
...
function viewFactory_Account_Host0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<any> {
...
export const AccountNgFactory:import87.ComponentFactory<import1.Account> = new import87.ComponentFactory<import1.Account>('ng-component',viewFactory_Account_Host0,import1.Account);
const styles_Account:any[] = [];
var renderType_Account:import80.RenderComponentType = null;
class _View_Account0 extends import81.AppView<import1.Account> {
  _viewQuery_accountNav_0:import101.QueryList<any>;
  _text_0:any;
  _el_1:any;
  private _appEl_1:import82.AppElement;
  _Menu_1_4:import102.Menu;
  _text_2:any;
  _el_3:any;
  ...
  _ToolbarTitle_7_4:import90.ToolbarTitle;
  _text_8:any;
  _text_9:any;
  _text_10:any;
  _text_11:any;
  ...
  _Content_12_4:import91.Content;
  _text_13:any;
  _el_14:any;
  _List_14_3:import103.List;
  _text_15:any;
  _el_16:any;
  private _appEl_16:import82.AppElement;
  _Item_16_4:import104.Item;
  _ItemContent_16_5:import104.ItemContent;
  _query_Label_16_0:import101.QueryList<any>;
  _query_Icon_16_1:import101.QueryList<any>;
  _text_17:any;
  _text_18:any;
  _el_19:any;
  private _appEl_19:import82.AppElement;
  _Item_19_4:import104.Item;
  _ItemContent_19_5:import104.ItemContent;
  _query_Label_19_0:import101.QueryList<any>;
  _query_Icon_19_1:import101.QueryList<any>;
  _text_20:any;
  _text_21:any;
  _el_22:any;
  private _appEl_22:import82.AppElement;
  _Item_22_4:import104.Item;
  _ItemContent_22_5:import104.ItemContent;
  _query_Label_22_0:import101.QueryList<any>;
  _query_Icon_22_1:import101.QueryList<any>;
  _text_23:any;
  _text_24:any;
  _el_25:any;
  private _appEl_25:import82.AppElement;
  _Item_25_4:import104.Item;
  _ItemContent_25_5:import104.ItemContent;
  _query_Label_25_0:import101.QueryList<any>;
  _query_Icon_25_1:import101.QueryList<any>;
  _text_26:any;
  _text_27:any;
  _text_28:any;
  _text_29:any;
  ...
  private _expr_8:any;
  constructor(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement) {
    super(_View_Account0,renderType_Account,import84.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import85.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import82.AppElement {
    const parentRenderNode:any = this.renderer.createViewRoot(this.declarationAppElement.nativeElement);
    this._viewQuery_accountNav_0 = new import101.QueryList<any>();
    this._text_0 = this.renderer.createText(parentRenderNode,'\n    ',null);
    ...
    this._Menu_1_4 = new import102.Menu(this.parentInjector.get(import37.MenuController),new import95.ElementRef(this._el_1),this.parentInjector.get(import66.Config),this.parentInjector.get(import65.Platform),this.renderer,this.parentInjector.get(import35.Keyboard),this.parentInjector.get(import58.NgZone),this.parentInjector.get(import34.GestureController));
    ...
    this._Header_3_3 = new import88.Header(this.parentInjector.get(import93.ViewController,null));
    ...
    this._appEl_5 = new import82.AppElement(5,3,this,this._el_5);
    var compView_5:any = import107.viewFactory_Toolbar0(this.viewUtils,this.injector(5),this._appEl_5);
    this._Toolbar_5_4 = new import88.Toolbar(this.parentInjector.get(import93.ViewController,null),this.parentInjector.get(import66.Config),new import95.ElementRef(this._el_5));
    ...
    var compView_7:any = import96.viewFactory_ToolbarTitle0(this.viewUtils,this.injector(7),this._appEl_7);
    this._ToolbarTitle_7_4 = new import90.ToolbarTitle(new import95.ElementRef(this._el_7),this._Toolbar_5_4,this.parentInjector.get(import89.Navbar,null));
    ...
    var compView_12:any = import97.viewFactory_Content0(this.viewUtils,this.injector(12),this._appEl_12);
    this._Content_12_4 = new import91.Content(new import95.ElementRef(this._el_12),this.parentInjector.get(import66.Config),this.parentInjector.get(import9.App),this.parentInjector.get(import35.Keyboard),this.parentInjector.get(import58.NgZone),this.parentInjector.get(import93.ViewController,null),this.parentInjector.get(import98.Tabs,null));
    ...
    this._List_14_3 = new import103.List(new import95.ElementRef(this._el_14),this.renderer,this.parentInjector.get(import34.GestureController));
    ...
    var compView_16:any = import108.viewFactory_Item0(this.viewUtils,this.injector(16),this._appEl_16);
    this._Item_16_4 = new import104.Item(this.parentInjector.get(import32.Form),this.renderer,new import95.ElementRef(this._el_16));
    this._ItemContent_16_5 = new import104.ItemContent();
    this._query_Label_16_0 = new import101.QueryList<any>();
    this._query_Icon_16_1 = new import101.QueryList<any>();
    ...
    var compView_19:any = import108.viewFactory_Item0(this.viewUtils,this.injector(19),this._appEl_19);
    this._Item_19_4 = new import104.Item(this.parentInjector.get(import32.Form),this.renderer,new import95.ElementRef(this._el_19));
    this._ItemContent_19_5 = new import104.ItemContent();
    this._query_Label_19_0 = new import101.QueryList<any>();
    this._query_Icon_19_1 = new import101.QueryList<any>();
    ...
    this._appEl_22 = new import82.AppElement(22,14,this,this._el_22);
    var compView_22:any = import108.viewFactory_Item0(this.viewUtils,this.injector(22),this._appEl_22);
    this._Item_22_4 = new import104.Item(this.parentInjector.get(import32.Form),this.renderer,new import95.ElementRef(this._el_22));
    this._ItemContent_22_5 = new import104.ItemContent();
    this._query_Label_22_0 = new import101.QueryList<any>();
    this._query_Icon_22_1 = new import101.QueryList<any>();
    ...
    this._appEl_25 = new import82.AppElement(25,14,this,this._el_25);
    var compView_25:any = import108.viewFactory_Item0(this.viewUtils,this.injector(25),this._appEl_25);
    this._Item_25_4 = new import104.Item(this.parentInjector.get(import32.Form),this.renderer,new import95.ElementRef(this._el_25));
    this._ItemContent_25_5 = new import104.ItemContent();
    this._query_Label_25_0 = new import101.QueryList<any>();
    this._query_Icon_25_1 = new import101.QueryList<any>();
    ...
    this._appEl_31 = new import82.AppElement(31,null,this,this._el_31);
    var compView_31:any = import109.viewFactory_Nav0(this.viewUtils,this.injector(31),this._appEl_31);
    this._Nav_31_4 = new import105.Nav(this.parentInjector.get(import93.ViewController,null),this.parentInjector.get(import110.NavControllerBase,null),this.parentInjector.get(import9.App),this.parentInjector.get(import66.Config),this.parentInjector.get(import35.Keyboard),new import95.ElementRef(this._el_31),this.parentInjector.get(import58.NgZone),this.renderer,this.parentInjector.get(import111.ComponentFactoryResolver),this.parentInjector.get(import34.GestureController),this.parentInjector.get(import44.TransitionController),this.parentInjector.get(import62.DeepLinker,null));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import90.ToolbarTitle) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 8)))) { return this._ToolbarTitle_7_4; }
    ...
    if (((token === import104.Item) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._Item_16_4; }
    if (((token === import104.ItemContent) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._ItemContent_16_5; }
    if (((token === import104.Item) && ((19 <= requestNodeIndex) && (requestNodeIndex <= 20)))) { return this._Item_19_4; }
    if (((token === import104.ItemContent) && ((19 <= requestNodeIndex) && (requestNodeIndex <= 20)))) { return this._ItemContent_19_5; }
    if (((token === import104.Item) && ((22 <= requestNodeIndex) && (requestNodeIndex <= 23)))) { return this._Item_22_4; }
    if (((token === import104.ItemContent) && ((22 <= requestNodeIndex) && (requestNodeIndex <= 23)))) { return this._ItemContent_22_5; }
    if (((token === import104.Item) && ((25 <= requestNodeIndex) && (requestNodeIndex <= 26)))) { return this._Item_25_4; }
    if (((token === import104.ItemContent) && ((25 <= requestNodeIndex) && (requestNodeIndex <= 26)))) { return this._ItemContent_25_5; }
    if (((token === import103.List) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 27)))) { return this._List_14_3; }
    if (((token === import91.Content) && ((12 <= requestNodeIndex) && (requestNodeIndex <= 28)))) { return this._Content_12_4; }
    if (((token === import102.Menu) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 29)))) { return this._Menu_1_4; }
    if (((token === import105.Nav) && (31 === requestNodeIndex))) { return this._Nav_31_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
export function viewFactory_Account0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.Account> {
  if ((renderType_Account === null)) { (renderType_Account = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/nav/test/nested/AppModule.ts class Account - inline template',0,import100.ViewEncapsulation.None,styles_Account,{})); }
  return new _View_Account0(viewUtils,parentInjector,declarationEl);
}
var renderType_Dashboard_Host:import80.RenderComponentType = null;
class _View_Dashboard_Host0 extends import81.AppView<any> {
  _el_0:any;
  private _appEl_0:import82.AppElement;
  _Dashboard_0_4:import1.Dashboard;
  constructor(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement) {
    super(_View_Dashboard_Host0,renderType_Dashboard_Host,import84.ViewType.HOST,viewUtils,parentInjector,declarationEl,import85.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import82.AppElement {
    this._el_0 = this.selectOrCreateHostElement('ng-component',rootSelector,null);
    this._appEl_0 = new import82.AppElement(0,null,this,this._el_0);
    var compView_0:any = viewFactory_Dashboard0(this.viewUtils,this.injector(0),this._appEl_0);
    this._Dashboard_0_4 = new import1.Dashboard(this.parentInjector.get(import86.NavController),this.parentInjector.get(import9.App));
...
function viewFactory_Dashboard_Host0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<any> {
...
export const DashboardNgFactory:import87.ComponentFactory<import1.Dashboard> = new import87.ComponentFactory<import1.Dashboard>('ng-component',viewFactory_Dashboard_Host0,import1.Dashboard);
const styles_Dashboard:any[] = [];
var renderType_Dashboard:import80.RenderComponentType = null;
class _View_Dashboard0 extends import81.AppView<import1.Dashboard> {
  _text_0:any;
  _el_1:any;
  _Header_1_3:import88.Header;
  _text_2:any;
  ...
  _MenuToggle_5_5:import112.MenuToggle;
  _ToolbarItem_5_6:import113.ToolbarItem;
  _query_Button_5_0:import101.QueryList<any>;
  _text_6:any;
  _el_7:any;
  _Icon_7_3:import114.Icon;
  _text_8:any;
  _text_9:any;
  _el_10:any;
  private _appEl_10:import82.AppElement;
  _ToolbarTitle_10_4:import90.ToolbarTitle;
  _text_11:any;
  _text_12:any;
  _text_13:any;
  _text_14:any;
  ...
  _Content_15_4:import91.Content;
  _text_16:any;
  _el_17:any;
  _el_18:any;
  ...
  private _expr_7:any;
  constructor(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement) {
    super(_View_Dashboard0,renderType_Dashboard,import84.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import85.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import82.AppElement {
    const parentRenderNode:any = this.renderer.createViewRoot(this.declarationAppElement.nativeElement);
    this._text_0 = this.renderer.createText(parentRenderNode,'\n    ',null);
    ...
    this._appEl_5 = new import82.AppElement(5,3,this,this._el_5);
    var compView_5:any = import99.viewFactory_Button0(this.viewUtils,this.injector(5),this._appEl_5);
    this._Button_5_4 = new import92.Button('',this.parentInjector.get(import66.Config),new import95.ElementRef(this._el_5),this.renderer);
    this._MenuToggle_5_5 = new import112.MenuToggle(this.parentInjector.get(import37.MenuController),new import95.ElementRef(this._el_5),this.parentInjector.get(import93.ViewController,null),this._Navbar_3_4);
    this._ToolbarItem_5_6 = new import113.ToolbarItem(new import95.ElementRef(this._el_5),this.parentInjector.get(import88.Toolbar,null),this._Navbar_3_4);
    this._query_Button_5_0 = new import101.QueryList<any>();
    ...
    this._Icon_7_3 = new import114.Icon(this.parentInjector.get(import66.Config),new import95.ElementRef(this._el_7),this.renderer);
    ...
    var compView_10:any = import96.viewFactory_ToolbarTitle0(this.viewUtils,this.injector(10),this._appEl_10);
    this._ToolbarTitle_10_4 = new import90.ToolbarTitle(new import95.ElementRef(this._el_10),this.parentInjector.get(import88.Toolbar,null),this._Navbar_3_4);
    ...
    var compView_15:any = import97.viewFactory_Content0(this.viewUtils,this.injector(15),this._appEl_15);
    this._Content_15_4 = new import91.Content(new import95.ElementRef(this._el_15),this.parentInjector.get(import66.Config),this.parentInjector.get(import9.App),this.parentInjector.get(import35.Keyboard),this.parentInjector.get(import58.NgZone),this.parentInjector.get(import93.ViewController,null),this.parentInjector.get(import98.Tabs,null));
    ...
    this._Button_18_4 = new import92.Button('',this.parentInjector.get(import66.Config),new import95.ElementRef(this._el_18),this.renderer);
    ...
    var compView_22:any = import99.viewFactory_Button0(this.viewUtils,this.injector(22),this._appEl_22);
    this._Button_22_4 = new import92.Button('',this.parentInjector.get(import66.Config),new import95.ElementRef(this._el_22),this.renderer);
    ...
    this._Button_26_4 = new import92.Button('',this.parentInjector.get(import66.Config),new import95.ElementRef(this._el_26),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import114.Icon) && (7 === requestNodeIndex))) { return this._Icon_7_3; }
    if (((token === import92.Button) && ((5 <= requestNodeIndex) && (requestNodeIndex <= 8)))) { return this._Button_5_4; }
    if (((token === import112.MenuToggle) && ((5 <= requestNodeIndex) && (requestNodeIndex <= 8)))) { return this._MenuToggle_5_5; }
    if (((token === import113.ToolbarItem) && ((5 <= requestNodeIndex) && (requestNodeIndex <= 8)))) { return this._ToolbarItem_5_6; }
    if (((token === import90.ToolbarTitle) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._ToolbarTitle_10_4; }
    if (((token === import89.Navbar) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 12)))) { return this._Navbar_3_4; }
    ...
    if (((token === import91.Content) && ((15 <= requestNodeIndex) && (requestNodeIndex <= 28)))) { return this._Content_15_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_3:any = '';
...
export function viewFactory_Dashboard0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.Dashboard> {
  if ((renderType_Dashboard === null)) { (renderType_Dashboard = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/nav/test/nested/AppModule.ts class Dashboard - inline template',0,import100.ViewEncapsulation.None,styles_Dashboard,{})); }
  return new _View_Dashboard0(viewUtils,parentInjector,declarationEl);
}
var renderType_Profile_Host:import80.RenderComponentType = null;
class _View_Profile_Host0 extends import81.AppView<any> {
  _el_0:any;
  private _appEl_0:import82.AppElement;
  _Profile_0_4:import1.Profile;
  constructor(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement) {
    super(_View_Profile_Host0,renderType_Profile_Host,import84.ViewType.HOST,viewUtils,parentInjector,declarationEl,import85.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import82.AppElement {
    this._el_0 = this.selectOrCreateHostElement('ng-component',rootSelector,null);
    this._appEl_0 = new import82.AppElement(0,null,this,this._el_0);
    var compView_0:any = viewFactory_Profile0(this.viewUtils,this.injector(0),this._appEl_0);
    this._Profile_0_4 = new import1.Profile(this.parentInjector.get(import86.NavController),this.parentInjector.get(import9.App));
...
function viewFactory_Profile_Host0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<any> {
...
export const ProfileNgFactory:import87.ComponentFactory<import1.Profile> = new import87.ComponentFactory<import1.Profile>('ng-component',viewFactory_Profile_Host0,import1.Profile);
const styles_Profile:any[] = [];
var renderType_Profile:import80.RenderComponentType = null;
class _View_Profile0 extends import81.AppView<import1.Profile> {
  _text_0:any;
  _el_1:any;
  _Header_1_3:import88.Header;
  _text_2:any;
  ...
  private _expr_7:any;
  constructor(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement) {
    super(_View_Profile0,renderType_Profile,import84.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import85.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import82.AppElement {
    const parentRenderNode:any = this.renderer.createViewRoot(this.declarationAppElement.nativeElement);
    this._text_0 = this.renderer.createText(parentRenderNode,'\n    ',null);
...
export function viewFactory_Profile0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.Profile> {
  if ((renderType_Profile === null)) { (renderType_Profile = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/nav/test/nested/AppModule.ts class Profile - inline template',0,import100.ViewEncapsulation.None,styles_Profile,{})); }
...
class _View_E2EApp0 extends import81.AppView<import1.E2EApp> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._Nav_0_4 = new import105.Nav(this.parentInjector.get(import93.ViewController,null),this.parentInjector.get(import110.NavControllerBase,null),this.parentInjector.get(import9.App),this.parentInjector.get(import66.Config),this.parentInjector.get(import35.Keyboard),new import95.ElementRef(this._el_0),this.parentInjector.get(import58.NgZone),this.renderer,this.parentInjector.get(import111.ComponentFactoryResolver),this.parentInjector.get(import34.GestureController),this.parentInjector.get(import44.TransitionController),this.parentInjector.get(import62.DeepLinker,null));
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/nav/test/nested/AppModule.ts class E2EApp - inline template',0,import100.ViewEncapsulation.None,styles_E2EApp,{})); }
