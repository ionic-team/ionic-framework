...
import * as import99 from '../../../item/item.ngfactory';
...
class _View_E2EPage0 extends import81.AppView<import1.E2EPage> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    var compView_30:any = import99.viewFactory_Item0(this.viewUtils,this.injector(30),this._appEl_30);
    this._Item_30_4 = new import90.Item(this.parentInjector.get(import32.Form),this.renderer,new import94.ElementRef(this._el_30));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import90.Item) && ((30 <= requestNodeIndex) && (requestNodeIndex <= 42)))) { return this._Item_30_4; }
    if (((token === import90.ItemContent) && ((30 <= requestNodeIndex) && (requestNodeIndex <= 42)))) { return this._ItemContent_30_5; }
    if (((token === import89.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 46)))) { return this._Content_9_4; }
    return notFoundResult;
  }
...
export function viewFactory_E2EPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EPage> {
  if ((renderType_E2EPage === null)) { (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/card/test/images/main.html',0,import100.ViewEncapsulation.Emulated,styles_E2EPage,{})); }
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/card/test/images/AppModule.ts class E2EApp - inline template',0,import100.ViewEncapsulation.None,styles_E2EApp,{})); }
