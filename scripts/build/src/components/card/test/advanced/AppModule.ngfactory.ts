...
class _View_E2EPage0 extends import81.AppView<import1.E2EPage> {
  ...
  _Button_33_4:import90.Button;
  _text_34:any;
  _el_35:any;
  _Icon_35_3:import91.Icon;
  _text_36:any;
  _text_37:any;
  _text_38:any;
  _el_39:any;
  ...
  _Button_132_4:import90.Button;
  _text_133:any;
  _el_134:any;
  _Icon_134_3:import91.Icon;
  _text_135:any;
  _text_136:any;
  _text_137:any;
  _el_138:any;
  ...
  _Button_140_4:import90.Button;
  _text_141:any;
  _el_142:any;
  _Icon_142_3:import91.Icon;
  _text_143:any;
  _text_144:any;
  _text_145:any;
  _text_146:any;
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_33,'icon-left','');
    ...
    var compView_33:any = import101.viewFactory_Button0(this.viewUtils,this.injector(33),this._appEl_33);
    this._Button_33_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_33),this.renderer);
    ...
    this._Icon_35_3 = new import91.Icon(this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_35),this.renderer);
    ...
    var compView_41:any = import101.viewFactory_Button0(this.viewUtils,this.injector(41),this._appEl_41);
    this._Button_41_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_41),this.renderer);
    ...
    this._Icon_43_3 = new import91.Icon(this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_43),this.renderer);
    ...
    var compView_52:any = import102.viewFactory_Item0(this.viewUtils,this.injector(52),this._appEl_52);
    this._Item_52_4 = new import92.Item(this.parentInjector.get(import32.Form),this.renderer,new import96.ElementRef(this._el_52));
    ...
    this.renderer.setElementAttribute(this._el_83,'icon-left','');
    this.renderer.setElementAttribute(this._el_83,'ion-button','');
    this.renderer.setElementAttribute(this._el_83,'small','');
    this._appEl_83 = new import82.AppElement(83,81,this,this._el_83);
    var compView_83:any = import101.viewFactory_Button0(this.viewUtils,this.injector(83),this._appEl_83);
    this._Button_83_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_83),this.renderer);
    ...
    this._Icon_85_3 = new import91.Icon(this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_85),this.renderer);
    ...
    var compView_91:any = import101.viewFactory_Button0(this.viewUtils,this.injector(91),this._appEl_91);
    this._Button_91_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_91),this.renderer);
    ...
    this._Icon_93_3 = new import91.Icon(this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_93),this.renderer);
    ...
    var compView_99:any = import101.viewFactory_Button0(this.viewUtils,this.injector(99),this._appEl_99);
    this._Button_99_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_99),this.renderer);
    ...
    this._Icon_101_3 = new import91.Icon(this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_101),this.renderer);
    ...
    this.renderer.setElementAttribute(this._el_124,'icon-left','');
    ...
    var compView_124:any = import101.viewFactory_Button0(this.viewUtils,this.injector(124),this._appEl_124);
    this._Button_124_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_124),this.renderer);
    ...
    this._Icon_126_3 = new import91.Icon(this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_126),this.renderer);
    ...
    this.renderer.setElementAttribute(this._el_132,'icon-left','');
    this.renderer.setElementAttribute(this._el_132,'ion-button','');
    this.renderer.setElementAttribute(this._el_132,'small','');
    this._appEl_132 = new import82.AppElement(132,130,this,this._el_132);
    var compView_132:any = import101.viewFactory_Button0(this.viewUtils,this.injector(132),this._appEl_132);
    this._Button_132_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_132),this.renderer);
    ...
    this._Icon_134_3 = new import91.Icon(this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_134),this.renderer);
    ...
    this.renderer.setElementAttribute(this._el_140,'icon-left','');
    ...
    var compView_140:any = import101.viewFactory_Button0(this.viewUtils,this.injector(140),this._appEl_140);
    this._Button_140_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_140),this.renderer);
    ...
    this._Icon_142_3 = new import91.Icon(this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_142),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import91.Icon) && (35 === requestNodeIndex))) { return this._Icon_35_3; }
    if (((token === import90.Button) && ((33 <= requestNodeIndex) && (requestNodeIndex <= 36)))) { return this._Button_33_4; }
    if (((token === import91.Icon) && (43 === requestNodeIndex))) { return this._Icon_43_3; }
    if (((token === import90.Button) && ((41 <= requestNodeIndex) && (requestNodeIndex <= 44)))) { return this._Button_41_4; }
    if (((token === import92.Item) && ((52 <= requestNodeIndex) && (requestNodeIndex <= 64)))) { return this._Item_52_4; }
    if (((token === import92.ItemContent) && ((52 <= requestNodeIndex) && (requestNodeIndex <= 64)))) { return this._ItemContent_52_5; }
    ...
    if (((token === import91.Icon) && (101 === requestNodeIndex))) { return this._Icon_101_3; }
    if (((token === import90.Button) && ((99 <= requestNodeIndex) && (requestNodeIndex <= 102)))) { return this._Button_99_4; }
    if (((token === import91.Icon) && (126 === requestNodeIndex))) { return this._Icon_126_3; }
    if (((token === import90.Button) && ((124 <= requestNodeIndex) && (requestNodeIndex <= 127)))) { return this._Button_124_4; }
    if (((token === import91.Icon) && (134 === requestNodeIndex))) { return this._Icon_134_3; }
    if (((token === import90.Button) && ((132 <= requestNodeIndex) && (requestNodeIndex <= 135)))) { return this._Button_132_4; }
    if (((token === import91.Icon) && (142 === requestNodeIndex))) { return this._Icon_142_3; }
    if (((token === import90.Button) && ((140 <= requestNodeIndex) && (requestNodeIndex <= 143)))) { return this._Button_140_4; }
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import83.checkBinding(throwOnChange,this._expr_6,currVal_6)) {
      this._Button_41_4.small = currVal_6;
      changed = true;
      this._expr_6 = currVal_6;
    }
    const currVal_7:any = '';
    if (import83.checkBinding(throwOnChange,this._expr_7,currVal_7)) {
      this._Button_41_4.clear = currVal_7;
      changed = true;
    ...
    const currVal_5:any = this._Icon_35_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_5,currVal_5)) {
      this.renderer.setElementClass(this._el_35,'hide',currVal_5);
    ...
    const currVal_13:any = this._Icon_85_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_13,currVal_13)) {
      this.renderer.setElementClass(this._el_85,'hide',currVal_13);
      this._expr_13 = currVal_13;
    }
    const currVal_17:any = this._Icon_93_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_17,currVal_17)) {
      this.renderer.setElementClass(this._el_93,'hide',currVal_17);
      this._expr_17 = currVal_17;
    }
    const currVal_21:any = this._Icon_101_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_21,currVal_21)) {
      this.renderer.setElementClass(this._el_101,'hide',currVal_21);
      this._expr_21 = currVal_21;
    }
    const currVal_25:any = this._Icon_126_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_25,currVal_25)) {
      this.renderer.setElementClass(this._el_126,'hide',currVal_25);
      this._expr_25 = currVal_25;
    }
    const currVal_29:any = this._Icon_134_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_29,currVal_29)) {
      this.renderer.setElementClass(this._el_134,'hide',currVal_29);
      this._expr_29 = currVal_29;
    }
    const currVal_33:any = this._Icon_142_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_33,currVal_33)) {
      this.renderer.setElementClass(this._el_142,'hide',currVal_33);
...
export function viewFactory_E2EPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EPage> {
  if ((renderType_E2EPage === null)) { (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/card/test/advanced/main.html',0,import103.ViewEncapsulation.Emulated,styles_E2EPage,{})); }
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/card/test/advanced/AppModule.ts class E2EApp - inline template',0,import103.ViewEncapsulation.None,styles_E2EApp,{})); }
