...
class _View_E2EPage0 extends import81.AppView<import1.E2EPage> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._text_68 = this.renderer.createText(null,'button[ion-button][outline][block]',null);
    ...
    this._Button_73_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_73),this.renderer);
    ...
    this._appEl_79 = new import82.AppElement(79,77,this,this._el_79);
    ...
    this._text_80 = this.renderer.createText(null,'button[ion-button][outline][block][secondary]',null);
    ...
    var compView_85:any = import98.viewFactory_Button0(this.viewUtils,this.injector(85),this._appEl_85);
    this._Button_85_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_85),this.renderer);
    ...
    var compView_91:any = import98.viewFactory_Button0(this.viewUtils,this.injector(91),this._appEl_91);
    this._Button_91_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_91),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import90.Button) && ((73 <= requestNodeIndex) && (requestNodeIndex <= 74)))) { return this._Button_73_4; }
    if (((token === import90.Button) && ((79 <= requestNodeIndex) && (requestNodeIndex <= 80)))) { return this._Button_79_4; }
    if (((token === import90.Button) && ((85 <= requestNodeIndex) && (requestNodeIndex <= 86)))) { return this._Button_85_4; }
    if (((token === import90.Button) && ((91 <= requestNodeIndex) && (requestNodeIndex <= 92)))) { return this._Button_91_4; }
...
export function viewFactory_E2EPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EPage> {
  if ((renderType_E2EPage === null)) { (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/button/test/outline/main.html',0,import99.ViewEncapsulation.None,styles_E2EPage,{})); }
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/button/test/outline/AppModule.ts class E2EApp - inline template',0,import99.ViewEncapsulation.None,styles_E2EApp,{})); }
