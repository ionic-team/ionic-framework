...
class _View_E2EPage0 extends import81.AppView<import1.E2EPage> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    var compView_11:any = import98.viewFactory_Button0(this.viewUtils,this.injector(11),this._appEl_11);
    this._Button_11_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_11),this.renderer);
    ...
    var compView_14:any = import98.viewFactory_Button0(this.viewUtils,this.injector(14),this._appEl_14);
    this._Button_14_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_14),this.renderer);
    ...
    var compView_20:any = import98.viewFactory_Button0(this.viewUtils,this.injector(20),this._appEl_20);
    this._Button_20_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_20),this.renderer);
    ...
    this._Button_29_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_29),this.renderer);
    ...
    var compView_38:any = import98.viewFactory_Button0(this.viewUtils,this.injector(38),this._appEl_38);
    this._Button_38_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import93.ElementRef(this._el_38),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import90.Button) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 12)))) { return this._Button_11_4; }
    if (((token === import90.Button) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 15)))) { return this._Button_14_4; }
    if (((token === import90.Button) && ((17 <= requestNodeIndex) && (requestNodeIndex <= 18)))) { return this._Button_17_4; }
    if (((token === import90.Button) && ((20 <= requestNodeIndex) && (requestNodeIndex <= 21)))) { return this._Button_20_4; }
    ...
    if (((token === import90.Button) && ((29 <= requestNodeIndex) && (requestNodeIndex <= 30)))) { return this._Button_29_4; }
...
export function viewFactory_E2EPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EPage> {
  if ((renderType_E2EPage === null)) { (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/button/test/round/main.html',0,import99.ViewEncapsulation.Emulated,styles_E2EPage,{})); }
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/button/test/round/AppModule.ts class E2EApp - inline template',0,import99.ViewEncapsulation.None,styles_E2EApp,{})); }
