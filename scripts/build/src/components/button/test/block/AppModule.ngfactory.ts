...
class _View_E2EPage0 extends import81.AppView<import1.E2EPage> {
  ...
  _Button_51_4:import90.Button;
  _text_52:any;
  _text_53:any;
  _el_54:any;
  private _appEl_54:import82.AppElement;
  _Button_54_4:import90.Button;
  _text_55:any;
  _text_56:any;
  _text_57:any;
  _el_58:any;
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._text_14 = this.renderer.createText(null,'a[ion-button][block]',null);
    ...
    var compView_16:any = import99.viewFactory_Button0(this.viewUtils,this.injector(16),this._appEl_16);
    this._Button_16_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import94.ElementRef(this._el_16),this.renderer);
    this._appEl_16.initComponent(this._Button_16_4,[],compView_16);
    this._text_17 = this.renderer.createText(null,'button[ion-button][block]',null);
    ...
    this.renderer.setElementAttribute(this._el_22,'icon-left','');
    ...
    this._Button_22_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import94.ElementRef(this._el_22),this.renderer);
    ...
    this._Icon_23_3 = new import91.Icon(this.parentInjector.get(import66.Config),new import94.ElementRef(this._el_23),this.renderer);
    this._text_24 = this.renderer.createText(null,' a[ion-button][block] icon',null);
    ...
    this._appEl_26 = new import82.AppElement(26,20,this,this._el_26);
    ...
    this._Icon_27_3 = new import91.Icon(this.parentInjector.get(import66.Config),new import94.ElementRef(this._el_27),this.renderer);
    this._text_28 = this.renderer.createText(null,' button[ion-button][block] icon',null);
    ...
    var compView_33:any = import99.viewFactory_Button0(this.viewUtils,this.injector(33),this._appEl_33);
    this._Button_33_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import94.ElementRef(this._el_33),this.renderer);
    this._appEl_33.initComponent(this._Button_33_4,[],compView_33);
    this._text_34 = this.renderer.createText(null,'a[ion-button][block][outline][secondary]',null);
    ...
    var compView_36:any = import99.viewFactory_Button0(this.viewUtils,this.injector(36),this._appEl_36);
    this._Button_36_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import94.ElementRef(this._el_36),this.renderer);
    this._appEl_36.initComponent(this._Button_36_4,[],compView_36);
    this._text_37 = this.renderer.createText(null,'button[ion-button][block][outline][secondary]',null);
    ...
    var compView_42:any = import99.viewFactory_Button0(this.viewUtils,this.injector(42),this._appEl_42);
    this._Button_42_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import94.ElementRef(this._el_42),this.renderer);
    this._appEl_42.initComponent(this._Button_42_4,[],compView_42);
    this._text_43 = this.renderer.createText(null,'a[ion-button][block][clear][dark]',null);
    ...
    var compView_45:any = import99.viewFactory_Button0(this.viewUtils,this.injector(45),this._appEl_45);
    this._Button_45_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import94.ElementRef(this._el_45),this.renderer);
    this._appEl_45.initComponent(this._Button_45_4,[],compView_45);
    this._text_46 = this.renderer.createText(null,'button[ion-button][clear][block][dark]',null);
    ...
    var compView_51:any = import99.viewFactory_Button0(this.viewUtils,this.injector(51),this._appEl_51);
    this._Button_51_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import94.ElementRef(this._el_51),this.renderer);
    this._appEl_51.initComponent(this._Button_51_4,[],compView_51);
    this._text_52 = this.renderer.createText(null,'a[ion-button][block][round]',null);
    ...
    this._Button_54_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import94.ElementRef(this._el_54),this.renderer);
    this._appEl_54.initComponent(this._Button_54_4,[],compView_54);
    this._text_55 = this.renderer.createText(null,'button[ion-button][block][round]',null);
    ...
    var compView_60:any = import99.viewFactory_Button0(this.viewUtils,this.injector(60),this._appEl_60);
    this._Button_60_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import94.ElementRef(this._el_60),this.renderer);
    this._appEl_60.initComponent(this._Button_60_4,[],compView_60);
    this._text_61 = this.renderer.createText(null,'a[ion-button][block][round][outline]',null);
    ...
    this._appEl_63 = new import82.AppElement(63,58,this,this._el_63);
    var compView_63:any = import99.viewFactory_Button0(this.viewUtils,this.injector(63),this._appEl_63);
    this._Button_63_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import94.ElementRef(this._el_63),this.renderer);
    this._appEl_63.initComponent(this._Button_63_4,[],compView_63);
    this._text_64 = this.renderer.createText(null,'button[ion-button][block][round][outline]',null);
    ...
    var compView_69:any = import99.viewFactory_Button0(this.viewUtils,this.injector(69),this._appEl_69);
    this._Button_69_4 = new import90.Button('',this.parentInjector.get(import66.Config),new import94.ElementRef(this._el_69),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import91.Icon) && (23 === requestNodeIndex))) { return this._Icon_23_3; }
    if (((token === import90.Button) && ((22 <= requestNodeIndex) && (requestNodeIndex <= 24)))) { return this._Button_22_4; }
    if (((token === import91.Icon) && (27 === requestNodeIndex))) { return this._Icon_27_3; }
    if (((token === import90.Button) && ((26 <= requestNodeIndex) && (requestNodeIndex <= 28)))) { return this._Button_26_4; }
    if (((token === import90.Button) && ((33 <= requestNodeIndex) && (requestNodeIndex <= 34)))) { return this._Button_33_4; }
    if (((token === import90.Button) && ((36 <= requestNodeIndex) && (requestNodeIndex <= 37)))) { return this._Button_36_4; }
    if (((token === import90.Button) && ((42 <= requestNodeIndex) && (requestNodeIndex <= 43)))) { return this._Button_42_4; }
    if (((token === import90.Button) && ((45 <= requestNodeIndex) && (requestNodeIndex <= 46)))) { return this._Button_45_4; }
    if (((token === import90.Button) && ((51 <= requestNodeIndex) && (requestNodeIndex <= 52)))) { return this._Button_51_4; }
    if (((token === import90.Button) && ((54 <= requestNodeIndex) && (requestNodeIndex <= 55)))) { return this._Button_54_4; }
    ...
    if (((token === import90.Button) && ((69 <= requestNodeIndex) && (requestNodeIndex <= 70)))) { return this._Button_69_4; }
    if (((token === import89.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 72)))) { return this._Content_9_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import83.checkBinding(throwOnChange,this._expr_13,currVal_13)) {
      this._Button_36_4.block = currVal_13;
      changed = true;
    ...
    const currVal_6:any = this._Icon_23_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_6,currVal_6)) {
      this.renderer.setElementClass(this._el_23,'hide',currVal_6);
      this._expr_6 = currVal_6;
    }
    const currVal_9:any = this._Icon_27_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_9,currVal_9)) {
      this.renderer.setElementClass(this._el_27,'hide',currVal_9);
...
export function viewFactory_E2EPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EPage> {
  if ((renderType_E2EPage === null)) { (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/button/test/block/main.html',0,import100.ViewEncapsulation.None,styles_E2EPage,{})); }
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/button/test/block/AppModule.ts class E2EApp - inline template',0,import100.ViewEncapsulation.None,styles_E2EApp,{})); }
