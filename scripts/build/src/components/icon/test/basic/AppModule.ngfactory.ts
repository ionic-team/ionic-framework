...
import * as import105 from '../../../nav/nav';
import * as import106 from '../../../nav/nav.ngfactory';
import * as import107 from '../../../../navigation/nav-controller-base';
...
class _View_E2EPage0 extends import81.AppView<import1.E2EPage> {
  ...
  _ItemContent_45_5:import91.ItemContent;
  ...
  _query_Label_53_0:import92.QueryList<any>;
  _query_Icon_53_1:import92.QueryList<any>;
  _text_54:any;
  _el_55:any;
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    var compView_21:any = import102.viewFactory_Item0(this.viewUtils,this.injector(21),this._appEl_21);
    this._Item_21_4 = new import91.Item(this.parentInjector.get(import32.Form),this.renderer,new import97.ElementRef(this._el_21));
    ...
    this._Icon_23_3 = new import93.Icon(this.parentInjector.get(import66.Config),new import97.ElementRef(this._el_23),this.renderer);
    ...
    var compView_29:any = import102.viewFactory_Item0(this.viewUtils,this.injector(29),this._appEl_29);
    this._Item_29_4 = new import91.Item(this.parentInjector.get(import32.Form),this.renderer,new import97.ElementRef(this._el_29));
    ...
    this._Icon_31_3 = new import93.Icon(this.parentInjector.get(import66.Config),new import97.ElementRef(this._el_31),this.renderer);
    ...
    this._Icon_39_3 = new import93.Icon(this.parentInjector.get(import66.Config),new import97.ElementRef(this._el_39),this.renderer);
    ...
    this._appEl_45 = new import82.AppElement(45,11,this,this._el_45);
    var compView_45:any = import102.viewFactory_Item0(this.viewUtils,this.injector(45),this._appEl_45);
    this._Item_45_4 = new import91.Item(this.parentInjector.get(import32.Form),this.renderer,new import97.ElementRef(this._el_45));
    this._ItemContent_45_5 = new import91.ItemContent();
    ...
    this._appEl_53 = new import82.AppElement(53,11,this,this._el_53);
    var compView_53:any = import102.viewFactory_Item0(this.viewUtils,this.injector(53),this._appEl_53);
    this._Item_53_4 = new import91.Item(this.parentInjector.get(import32.Form),this.renderer,new import97.ElementRef(this._el_53));
    this._ItemContent_53_5 = new import91.ItemContent();
    this._query_Label_53_0 = new import92.QueryList<any>();
    this._query_Icon_53_1 = new import92.QueryList<any>();
    ...
    var compView_61:any = import102.viewFactory_Item0(this.viewUtils,this.injector(61),this._appEl_61);
    this._Item_61_4 = new import91.Item(this.parentInjector.get(import32.Form),this.renderer,new import97.ElementRef(this._el_61));
    ...
    this._Icon_63_3 = new import93.Icon(this.parentInjector.get(import66.Config),new import97.ElementRef(this._el_63),this.renderer);
    ...
    var compView_69:any = import102.viewFactory_Item0(this.viewUtils,this.injector(69),this._appEl_69);
    this._Item_69_4 = new import91.Item(this.parentInjector.get(import32.Form),this.renderer,new import97.ElementRef(this._el_69));
    ...
    this._Icon_71_3 = new import93.Icon(this.parentInjector.get(import66.Config),new import97.ElementRef(this._el_71),this.renderer);
    ...
    this._appEl_77 = new import82.AppElement(77,11,this,this._el_77);
    var compView_77:any = import102.viewFactory_Item0(this.viewUtils,this.injector(77),this._appEl_77);
    this._Item_77_4 = new import91.Item(this.parentInjector.get(import32.Form),this.renderer,new import97.ElementRef(this._el_77));
    ...
    this._Icon_79_3 = new import93.Icon(this.parentInjector.get(import66.Config),new import97.ElementRef(this._el_79),this.renderer);
    ...
    this._appEl_85 = new import82.AppElement(85,11,this,this._el_85);
    var compView_85:any = import102.viewFactory_Item0(this.viewUtils,this.injector(85),this._appEl_85);
    this._Item_85_4 = new import91.Item(this.parentInjector.get(import32.Form),this.renderer,new import97.ElementRef(this._el_85));
    ...
    this._Button_94_4 = new import94.Button('',this.parentInjector.get(import66.Config),new import97.ElementRef(this._el_94),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import93.Icon) && (23 === requestNodeIndex))) { return this._Icon_23_3; }
    ...
    if (((token === import93.Icon) && (31 === requestNodeIndex))) { return this._Icon_31_3; }
    if (((token === import91.Item) && ((29 <= requestNodeIndex) && (requestNodeIndex <= 35)))) { return this._Item_29_4; }
    if (((token === import91.ItemContent) && ((29 <= requestNodeIndex) && (requestNodeIndex <= 35)))) { return this._ItemContent_29_5; }
    if (((token === import93.Icon) && (39 === requestNodeIndex))) { return this._Icon_39_3; }
    if (((token === import91.Item) && ((37 <= requestNodeIndex) && (requestNodeIndex <= 43)))) { return this._Item_37_4; }
    if (((token === import91.ItemContent) && ((37 <= requestNodeIndex) && (requestNodeIndex <= 43)))) { return this._ItemContent_37_5; }
    if (((token === import93.Icon) && (47 === requestNodeIndex))) { return this._Icon_47_3; }
    if (((token === import91.Item) && ((45 <= requestNodeIndex) && (requestNodeIndex <= 51)))) { return this._Item_45_4; }
    if (((token === import91.ItemContent) && ((45 <= requestNodeIndex) && (requestNodeIndex <= 51)))) { return this._ItemContent_45_5; }
    if (((token === import93.Icon) && (55 === requestNodeIndex))) { return this._Icon_55_3; }
    if (((token === import91.Item) && ((53 <= requestNodeIndex) && (requestNodeIndex <= 59)))) { return this._Item_53_4; }
    if (((token === import91.ItemContent) && ((53 <= requestNodeIndex) && (requestNodeIndex <= 59)))) { return this._ItemContent_53_5; }
    if (((token === import93.Icon) && (63 === requestNodeIndex))) { return this._Icon_63_3; }
    ...
    if (((token === import91.Item) && ((69 <= requestNodeIndex) && (requestNodeIndex <= 75)))) { return this._Item_69_4; }
    if (((token === import91.ItemContent) && ((69 <= requestNodeIndex) && (requestNodeIndex <= 75)))) { return this._ItemContent_69_5; }
    if (((token === import93.Icon) && (79 === requestNodeIndex))) { return this._Icon_79_3; }
    ...
    if (((token === import91.Item) && ((85 <= requestNodeIndex) && (requestNodeIndex <= 89)))) { return this._Item_85_4; }
    if (((token === import91.ItemContent) && ((85 <= requestNodeIndex) && (requestNodeIndex <= 89)))) { return this._ItemContent_85_5; }
    if (((token === import90.List) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 90)))) { return this._List_11_3; }
    if (((token === import93.Icon) && (96 === requestNodeIndex))) { return this._Icon_96_3; }
    if (((token === import94.Button) && ((94 <= requestNodeIndex) && (requestNodeIndex <= 97)))) { return this._Button_94_4; }
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_4:any = this.context.homeIcon;
    ...
    if (!throwOnChange) {
      ...
      if (this._query_Icon_29_1.dirty) {
        this._query_Icon_29_1.reset([this._Icon_31_3]);
      ...
      if (this._query_Icon_45_1.dirty) {
        this._query_Icon_45_1.reset([this._Icon_47_3]);
      ...
      if (this._query_Icon_61_1.dirty) {
        this._query_Icon_61_1.reset([this._Icon_63_3]);
    ...
    const currVal_8:any = this._Icon_31_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_8,currVal_8)) {
      this.renderer.setElementClass(this._el_31,'hide',currVal_8);
      this._expr_8 = currVal_8;
    }
    const currVal_11:any = this._Icon_39_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_11,currVal_11)) {
      this.renderer.setElementClass(this._el_39,'hide',currVal_11);
    ...
    const currVal_17:any = this._Icon_63_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_17,currVal_17)) {
      this.renderer.setElementClass(this._el_63,'hide',currVal_17);
      this._expr_17 = currVal_17;
    }
    const currVal_19:any = this._Icon_71_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_19,currVal_19)) {
      this.renderer.setElementClass(this._el_71,'hide',currVal_19);
      this._expr_19 = currVal_19;
    }
    const currVal_22:any = this._Icon_79_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_22,currVal_22)) {
      this.renderer.setElementClass(this._el_79,'hide',currVal_22);
      this._expr_22 = currVal_22;
    }
    const currVal_25:any = this._Icon_96_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_25,currVal_25)) {
      this.renderer.setElementClass(this._el_96,'hide',currVal_25);
...
export function viewFactory_E2EPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EPage> {
  if ((renderType_E2EPage === null)) { (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/icon/test/basic/main.html',0,import104.ViewEncapsulation.Emulated,styles_E2EPage,{})); }
...
class _View_E2EApp0 extends import81.AppView<import1.E2EApp> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._Nav_0_4 = new import105.Nav(this.parentInjector.get(import95.ViewController,null),this.parentInjector.get(import107.NavControllerBase,null),this.parentInjector.get(import9.App),this.parentInjector.get(import66.Config),this.parentInjector.get(import35.Keyboard),new import97.ElementRef(this._el_0),this.parentInjector.get(import58.NgZone),this.renderer,this.parentInjector.get(import108.ComponentFactoryResolver),this.parentInjector.get(import34.GestureController),this.parentInjector.get(import44.TransitionController),this.parentInjector.get(import62.DeepLinker,null));
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/icon/test/basic/AppModule.ts class E2EApp - inline template',0,import104.ViewEncapsulation.None,styles_E2EApp,{})); }
