...
import * as import30 from '../../action-sheet';
...
import * as import46 from '../../action-sheet-component.ngfactory';
...
class _View_E2EPage_Host0 extends import81.AppView<any> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._E2EPage_0_4 = new import1.E2EPage(this.parentInjector.get(import30.ActionSheetController),this.parentInjector.get(import31.AlertController),this.parentInjector.get(import38.ModalController),this.parentInjector.get(import65.Platform));
...
class _View_E2EPage0 extends import81.AppView<import1.E2EPage> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    var compView_2:any = import93.viewFactory_Navbar0(this.viewUtils,this.injector(2),this._appEl_2);
    this._Navbar_2_4 = new import88.Navbar(this.parentInjector.get(import9.App),this.parentInjector.get(import92.ViewController,null),this.parentInjector.get(import94.NavController,null),new import95.ElementRef(this._el_2),this.parentInjector.get(import66.Config),this.renderer);
    ...
    this._ToolbarTitle_4_4 = new import89.ToolbarTitle(new import95.ElementRef(this._el_4),this.parentInjector.get(import87.Toolbar,null),this._Navbar_2_4);
    ...
    this._Content_9_4 = new import90.Content(new import95.ElementRef(this._el_9),this.parentInjector.get(import66.Config),this.parentInjector.get(import9.App),this.parentInjector.get(import35.Keyboard),this.parentInjector.get(import58.NgZone),this.parentInjector.get(import92.ViewController,null),this.parentInjector.get(import98.Tabs,null));
    ...
    this._Button_11_4 = new import91.Button('',this.parentInjector.get(import66.Config),new import95.ElementRef(this._el_11),this.renderer);
    ...
    this._Button_14_4 = new import91.Button('',this.parentInjector.get(import66.Config),new import95.ElementRef(this._el_14),this.renderer);
    ...
    this._Button_17_4 = new import91.Button('',this.parentInjector.get(import66.Config),new import95.ElementRef(this._el_17),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import90.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 22)))) { return this._Content_9_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_9:any = import83.interpolate(1,'    Result: ',this.context.result,'\n  ');
...
export function viewFactory_E2EPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EPage> {
  if ((renderType_E2EPage === null)) { (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/action-sheet/test/basic/main.html',0,import100.ViewEncapsulation.None,styles_E2EPage,{})); }
...
class _View_ModalPage_Host0 extends import81.AppView<any> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._ModalPage_0_4 = new import1.ModalPage(this.parentInjector.get(import92.ViewController));
...
class _View_ModalPage0 extends import81.AppView<import1.ModalPage> {
  ...
  _text_4:any;
  _el_5:any;
  _ToolbarItem_5_3:import101.ToolbarItem;
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    var compView_3:any = import103.viewFactory_Toolbar0(this.viewUtils,this.injector(3),this._appEl_3);
    this._Toolbar_3_4 = new import87.Toolbar(this.parentInjector.get(import92.ViewController,null),this.parentInjector.get(import66.Config),new import95.ElementRef(this._el_3));
    ...
    this._ToolbarItem_5_3 = new import101.ToolbarItem(new import95.ElementRef(this._el_5),this._Toolbar_3_4,this.parentInjector.get(import88.Navbar,null));
    ...
    this._Button_7_4 = new import91.Button('',this.parentInjector.get(import66.Config),new import95.ElementRef(this._el_7),this.renderer);
    ...
    var compView_11:any = import96.viewFactory_ToolbarTitle0(this.viewUtils,this.injector(11),this._appEl_11);
    this._ToolbarTitle_11_4 = new import89.ToolbarTitle(new import95.ElementRef(this._el_11),this._Toolbar_3_4,this.parentInjector.get(import88.Navbar,null));
    ...
    var compView_16:any = import97.viewFactory_Content0(this.viewUtils,this.injector(16),this._appEl_16);
    this._Content_16_4 = new import90.Content(new import95.ElementRef(this._el_16),this.parentInjector.get(import66.Config),this.parentInjector.get(import9.App),this.parentInjector.get(import35.Keyboard),this.parentInjector.get(import58.NgZone),this.parentInjector.get(import92.ViewController,null),this.parentInjector.get(import98.Tabs,null));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import101.ToolbarItem) && ((5 <= requestNodeIndex) && (requestNodeIndex <= 9)))) { return this._ToolbarItem_5_3; }
    ...
    if (((token === import90.Content) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._Content_16_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
export function viewFactory_ModalPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.ModalPage> {
  if ((renderType_ModalPage === null)) { (renderType_ModalPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/action-sheet/test/basic/AppModule.ts class ModalPage - inline template',0,import100.ViewEncapsulation.None,styles_ModalPage,{})); }
...
class _View_E2EApp0 extends import81.AppView<import1.E2EApp> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._Nav_0_4 = new import104.Nav(this.parentInjector.get(import92.ViewController,null),this.parentInjector.get(import106.NavControllerBase,null),this.parentInjector.get(import9.App),this.parentInjector.get(import66.Config),this.parentInjector.get(import35.Keyboard),new import95.ElementRef(this._el_0),this.parentInjector.get(import58.NgZone),this.renderer,this.parentInjector.get(import107.ComponentFactoryResolver),this.parentInjector.get(import34.GestureController),this.parentInjector.get(import44.TransitionController),this.parentInjector.get(import62.DeepLinker,null));
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/action-sheet/test/basic/AppModule.ts class E2EApp - inline template',0,import100.ViewEncapsulation.None,styles_E2EApp,{})); }
