...
class _View_E2EApp_Host0 extends import81.AppView<any> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._E2EApp_0_4 = new import1.E2EApp(this.parentInjector.get(import78.Http));
...
class _View_E2EApp0 extends import81.AppView<import1.E2EApp> {
  _viewQuery_Slides_0:import87.QueryList<any>;
  _el_0:any;
  private _appEl_0:import82.AppElement;
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._viewQuery_Slides_0 = new import87.QueryList<any>();
    ...
    this._appEl_2 = new import82.AppElement(2,0,this,this._anchor_2);
    this._TemplateRef_2_5 = new import92.TemplateRef_(this._appEl_2,viewFactory_E2EApp1);
    this._NgFor_2_6 = new import89.NgFor(this._appEl_2.vcRef,this._TemplateRef_2_5,this.parentInjector.get(import75.IterableDiffers),this.ref);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import92.TemplateRef) && (2 === requestNodeIndex))) { return this._TemplateRef_2_5; }
    if (((token === import89.NgFor) && (2 === requestNodeIndex))) { return this._NgFor_2_6; }
    if (((token === import88.Slides) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._Slides_0_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/slides/test/basic/main.html',0,import93.ViewEncapsulation.Emulated,styles_E2EApp,{})); }
  return new _View_E2EApp0(viewUtils,parentInjector,declarationEl);
}
class _View_E2EApp1 extends import81.AppView<any> {
  _el_0:any;
  private _appEl_0:import82.AppElement;
  _Slide_0_4:import88.Slide;
  _text_1:any;
  _el_2:any;
  _text_3:any;
  private _expr_0:any;
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._Slide_0_4 = new import88.Slide(new import91.ElementRef(this._el_0),(<_View_E2EApp0>this.parent)._Slides_0_4);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import88.Slide) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._Slide_0_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_0:any = import83.interpolate(1,'',this.parent.context.getImageUrl(this.context.$implicit),'');
    if (import83.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
      this.renderer.setElementProperty(this._el_2,'src',this.viewUtils.sanitizer.sanitize(import94.SecurityContext.URL,currVal_0));
      this._expr_0 = currVal_0;
    }
    this.detectViewChildrenChanges(throwOnChange);
  }
