...
import * as import94 from '@angular/common/src/directives/ng_class';
...
class _View_E2EApp0 extends import81.AppView<import1.E2EApp> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    var compView_2:any = import90.viewFactory_Slides0(this.viewUtils,this.injector(2),this._appEl_2);
    this._Slides_2_4 = new import88.Slides(new import91.ElementRef(this._el_2),this.renderer);
    ...
    this._TemplateRef_4_5 = new import92.TemplateRef_(this._appEl_4,viewFactory_E2EApp1);
    ...
    var compView_10:any = import90.viewFactory_Slides0(this.viewUtils,this.injector(10),this._appEl_10);
    this._Slides_10_4 = new import88.Slides(new import91.ElementRef(this._el_10),this.renderer);
    ...
    this._appEl_12 = new import82.AppElement(12,10,this,this._anchor_12);
    this._TemplateRef_12_5 = new import92.TemplateRef_(this._appEl_12,viewFactory_E2EApp2);
    this._NgFor_12_6 = new import89.NgFor(this._appEl_12.vcRef,this._TemplateRef_12_5,this.parentInjector.get(import75.IterableDiffers),this.ref);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import92.TemplateRef) && (4 === requestNodeIndex))) { return this._TemplateRef_4_5; }
    if (((token === import89.NgFor) && (4 === requestNodeIndex))) { return this._NgFor_4_6; }
    if (((token === import88.Slides) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 5)))) { return this._Slides_2_4; }
    if (((token === import92.TemplateRef) && (12 === requestNodeIndex))) { return this._TemplateRef_12_5; }
    if (((token === import89.NgFor) && (12 === requestNodeIndex))) { return this._NgFor_12_6; }
    if (((token === import88.Slides) && ((10 <= requestNodeIndex) && (requestNodeIndex <= 13)))) { return this._Slides_10_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/slides/test/loop/main.html',0,import93.ViewEncapsulation.Emulated,styles_E2EApp,{})); }
  return new _View_E2EApp0(viewUtils,parentInjector,declarationEl);
}
class _View_E2EApp1 extends import81.AppView<any> {
  _el_0:any;
  private _appEl_0:import82.AppElement;
  _NgClass_0_4:import94.NgClass;
  _Slide_0_5:import88.Slide;
  _text_1:any;
  private _expr_0:any;
  private _expr_1:any;
  constructor(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement) {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._NgClass_0_4 = new import94.NgClass(this.parent.parentInjector.get(import75.IterableDiffers),this.parent.parentInjector.get(import76.KeyValueDiffers),new import91.ElementRef(this._el_0),this.renderer);
    this._Slide_0_5 = new import88.Slide(new import91.ElementRef(this._el_0),(<_View_E2EApp0>this.parent)._Slides_2_4);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import94.NgClass) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._NgClass_0_4; }
    if (((token === import88.Slide) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._Slide_0_5; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
class _View_E2EApp2 extends import81.AppView<any> {
  _el_0:any;
  private _appEl_0:import82.AppElement;
  _NgClass_0_4:import94.NgClass;
  _Slide_0_5:import88.Slide;
  ...
  private _expr_1:any;
  constructor(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement) {
    super(_View_E2EApp2,renderType_E2EApp,import84.ViewType.EMBEDDED,viewUtils,parentInjector,declarationEl,import85.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import82.AppElement {
    this._el_0 = this.renderer.createElement(null,'ion-slide',null);
    this._appEl_0 = new import82.AppElement(0,null,this,this._el_0);
    var compView_0:any = import90.viewFactory_Slide0(this.viewUtils,this.injector(0),this._appEl_0);
    this._NgClass_0_4 = new import94.NgClass(this.parent.parentInjector.get(import75.IterableDiffers),this.parent.parentInjector.get(import76.KeyValueDiffers),new import91.ElementRef(this._el_0),this.renderer);
    this._Slide_0_5 = new import88.Slide(new import91.ElementRef(this._el_0),(<_View_E2EApp0>this.parent)._Slides_10_4);
    this._appEl_0.initComponent(this._Slide_0_5,[],compView_0);
    this._text_1 = this.renderer.createText(null,'',null);
    compView_0.create(this._Slide_0_5,[[].concat([this._text_1])],null);
    this._expr_0 = import85.UNINITIALIZED;
...
function viewFactory_E2EApp2(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<any> {
