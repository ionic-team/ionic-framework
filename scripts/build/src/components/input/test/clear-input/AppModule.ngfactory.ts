...
class _View_E2EPage0 extends import81.AppView<import1.E2EPage> {
  ...
  _NgModel_26_4:import94.NgModel;
  _NgControl_26_5:any;
  _NgControlStatus_26_6:import95.NgControlStatus;
  _TextInput_26_7:import96.TextInput;
  _text_27:any;
  _el_28:any;
  private _appEl_28:import82.AppElement;
  _Button_28_4:import97.Button;
  _text_29:any;
  _text_30:any;
  _text_31:any;
  _el_32:any;
  private _appEl_32:import82.AppElement;
  _Item_32_4:import91.Item;
  _ItemContent_32_5:import91.ItemContent;
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    var compView_18:any = import106.viewFactory_TextInput0(this.viewUtils,this.injector(18),this._appEl_18);
    ...
    this._TextInput_18_7 = new import96.TextInput(this.parentInjector.get(import66.Config),this.parentInjector.get(import32.Form),this._Item_13_4,this.parentInjector.get(import9.App),this.parentInjector.get(import65.Platform),new import100.ElementRef(this._el_18),this._Content_9_4,this.parentInjector.get(import107.NavController,null),this._NgControl_18_5);
    ...
    var compView_21:any = import105.viewFactory_Item0(this.viewUtils,this.injector(21),this._appEl_21);
    ...
    var compView_26:any = import106.viewFactory_TextInput0(this.viewUtils,this.injector(26),this._appEl_26);
    this._NgModel_26_4 = new import94.NgModel(null,null,null,null);
    this._NgControl_26_5 = this._NgModel_26_4;
    this._NgControlStatus_26_6 = new import95.NgControlStatus(this._NgControl_26_5);
    this._TextInput_26_7 = new import96.TextInput(this.parentInjector.get(import66.Config),this.parentInjector.get(import32.Form),this._Item_21_4,this.parentInjector.get(import9.App),this.parentInjector.get(import65.Platform),new import100.ElementRef(this._el_26),this._Content_9_4,this.parentInjector.get(import107.NavController,null),this._NgControl_26_5);
    ...
    var compView_28:any = import108.viewFactory_Button0(this.viewUtils,this.injector(28),this._appEl_28);
    this._Button_28_4 = new import97.Button('',this.parentInjector.get(import66.Config),new import100.ElementRef(this._el_28),this.renderer);
    ...
    this._appEl_32 = new import82.AppElement(32,11,this,this._el_32);
    var compView_32:any = import105.viewFactory_Item0(this.viewUtils,this.injector(32),this._appEl_32);
    this._Item_32_4 = new import91.Item(this.parentInjector.get(import32.Form),this.renderer,new import100.ElementRef(this._el_32));
    this._ItemContent_32_5 = new import91.ItemContent();
    ...
    var compView_36:any = import108.viewFactory_Button0(this.viewUtils,this.injector(36),this._appEl_36);
    this._Button_36_4 = new import97.Button('',this.parentInjector.get(import66.Config),new import100.ElementRef(this._el_36),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import109.NgControl) && (18 === requestNodeIndex))) { return this._NgControl_18_5; }
    ...
    if (((token === import94.NgModel) && (26 === requestNodeIndex))) { return this._NgModel_26_4; }
    if (((token === import109.NgControl) && (26 === requestNodeIndex))) { return this._NgControl_26_5; }
    if (((token === import95.NgControlStatus) && (26 === requestNodeIndex))) { return this._NgControlStatus_26_6; }
    if (((token === import96.TextInput) && (26 === requestNodeIndex))) { return this._TextInput_26_7; }
    if (((token === import97.Button) && ((28 <= requestNodeIndex) && (requestNodeIndex <= 29)))) { return this._Button_28_4; }
    if (((token === import91.Item) && ((21 <= requestNodeIndex) && (requestNodeIndex <= 30)))) { return this._Item_21_4; }
    if (((token === import91.ItemContent) && ((21 <= requestNodeIndex) && (requestNodeIndex <= 30)))) { return this._ItemContent_21_5; }
    if (((token === import97.Button) && ((36 <= requestNodeIndex) && (requestNodeIndex <= 37)))) { return this._Button_36_4; }
    if (((token === import91.Item) && ((32 <= requestNodeIndex) && (requestNodeIndex <= 38)))) { return this._Item_32_4; }
    if (((token === import91.ItemContent) && ((32 <= requestNodeIndex) && (requestNodeIndex <= 38)))) { return this._ItemContent_32_5; }
    if (((token === import90.List) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 39)))) { return this._List_11_3; }
    if (((token === import89.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 40)))) { return this._Content_9_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import83.checkBinding(throwOnChange,this._expr_12,currVal_12)) {
      ...
      if ((changes === null)) { (changes = {}); }
      changes['model'] = new import85.SimpleChange(this._expr_12,currVal_12);
      this._expr_12 = currVal_12;
    }
    if ((changes !== null)) { this._NgModel_26_4.ngOnChanges(changes); }
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._TextInput_26_7.ngOnInit(); }
    ...
    if (!throwOnChange) {
      ...
      this._TextInput_26_7.ngAfterContentChecked();
  ...
  destroyInternal():void {
    ...
    this._TextInput_26_7.ngOnDestroy();
...
export function viewFactory_E2EPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EPage> {
  if ((renderType_E2EPage === null)) { (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/input/test/clear-input/main.html',0,import110.ViewEncapsulation.None,styles_E2EPage,{})); }
...
class _View_E2EApp0 extends import81.AppView<import1.E2EApp> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._Nav_0_4 = new import111.Nav(this.parentInjector.get(import98.ViewController,null),this.parentInjector.get(import113.NavControllerBase,null),this.parentInjector.get(import9.App),this.parentInjector.get(import66.Config),this.parentInjector.get(import35.Keyboard),new import100.ElementRef(this._el_0),this.parentInjector.get(import58.NgZone),this.renderer,this.parentInjector.get(import114.ComponentFactoryResolver),this.parentInjector.get(import34.GestureController),this.parentInjector.get(import44.TransitionController),this.parentInjector.get(import62.DeepLinker,null));
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/input/test/clear-input/AppModule.ts class E2EApp - inline template',0,import110.ViewEncapsulation.None,styles_E2EApp,{})); }
