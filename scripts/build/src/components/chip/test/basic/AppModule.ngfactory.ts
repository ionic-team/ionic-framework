...
class _View_E2EPage0 extends import81.AppView<import1.E2EPage> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._Label_15_3 = new import90.Label(new import93.ElementRef(this._el_15),this.renderer,null,null,null,null);
    ...
    this._Label_24_3 = new import90.Label(new import93.ElementRef(this._el_24),this.renderer,null,null,null,null);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import90.Label) && ((24 <= requestNodeIndex) && (requestNodeIndex <= 25)))) { return this._Label_24_3; }
    if (((token === import89.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 28)))) { return this._Content_9_4; }
    return notFoundResult;
  }
...
export function viewFactory_E2EPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EPage> {
  if ((renderType_E2EPage === null)) { (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/chip/test/basic/main.html',0,import98.ViewEncapsulation.None,styles_E2EPage,{})); }
...
class _View_E2EApp0 extends import81.AppView<import1.E2EApp> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._Nav_0_4 = new import99.Nav(this.parentInjector.get(import91.ViewController,null),this.parentInjector.get(import101.NavControllerBase,null),this.parentInjector.get(import9.App),this.parentInjector.get(import66.Config),this.parentInjector.get(import35.Keyboard),new import93.ElementRef(this._el_0),this.parentInjector.get(import58.NgZone),this.renderer,this.parentInjector.get(import102.ComponentFactoryResolver),this.parentInjector.get(import34.GestureController),this.parentInjector.get(import44.TransitionController),this.parentInjector.get(import62.DeepLinker,null));
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/chip/test/basic/AppModule.ts class E2EApp - inline template',0,import98.ViewEncapsulation.None,styles_E2EApp,{})); }
