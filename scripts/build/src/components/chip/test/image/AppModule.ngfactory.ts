...
class _View_E2EPage0 extends import81.AppView<import1.E2EPage> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._Label_20_3 = new import90.Label(new import93.ElementRef(this._el_20),this.renderer,null,null,null,null);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import90.Label) && ((20 <= requestNodeIndex) && (requestNodeIndex <= 21)))) { return this._Label_20_3; }
    if (((token === import89.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 24)))) { return this._Content_9_4; }
    return notFoundResult;
  }
...
export function viewFactory_E2EPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EPage> {
  if ((renderType_E2EPage === null)) { (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/chip/test/image/main.html',0,import98.ViewEncapsulation.None,styles_E2EPage,{})); }
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/chip/test/image/AppModule.ts class E2EApp - inline template',0,import98.ViewEncapsulation.None,styles_E2EApp,{})); }
