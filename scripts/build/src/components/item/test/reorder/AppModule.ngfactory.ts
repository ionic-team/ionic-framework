...
import * as import93 from '../../item-reorder';
import * as import94 from '../../../list/list';
import * as import95 from '@angular/common/src/directives/ng_for';
...
import * as import106 from '../../item';
import * as import107 from '../../item.ngfactory';
...
class _View_E2EPage0 extends import81.AppView<import1.E2EPage> {
  ...
  _text_16:any;
  _el_17:any;
  _ItemReorder_17_3:import93.ItemReorder;
  _List_17_4:import94.List;
  _text_18:any;
  _anchor_19:any;
  private _appEl_19:import82.AppElement;
  _TemplateRef_19_5:any;
  _NgFor_19_6:import95.NgFor;
  _text_20:any;
  _text_21:any;
  _text_22:any;
  private _expr_0:any;
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._ToolbarItem_7_3 = new import89.ToolbarItem(new import98.ElementRef(this._el_7),this._Toolbar_2_4,this.parentInjector.get(import100.Navbar,null));
    ...
    var compView_9:any = import101.viewFactory_Button0(this.viewUtils,this.injector(9),this._appEl_9);
    this._Button_9_4 = new import91.Button('',this.parentInjector.get(import66.Config),new import98.ElementRef(this._el_9),this.renderer);
    ...
    this._Content_15_4 = new import92.Content(new import98.ElementRef(this._el_15),this.parentInjector.get(import66.Config),this.parentInjector.get(import9.App),this.parentInjector.get(import35.Keyboard),this.parentInjector.get(import58.NgZone),this.parentInjector.get(import96.ViewController,null),this.parentInjector.get(import103.Tabs,null));
    ...
    this._ItemReorder_17_3 = new import93.ItemReorder(new import98.ElementRef(this._el_17),this.renderer,this.parentInjector.get(import58.NgZone),this._Content_15_4);
    this._List_17_4 = new import94.List(new import98.ElementRef(this._el_17),this.renderer,this.parentInjector.get(import34.GestureController));
    ...
    this._TemplateRef_19_5 = new import104.TemplateRef_(this._appEl_19,viewFactory_E2EPage1);
    this._NgFor_19_6 = new import95.NgFor(this._appEl_19.vcRef,this._TemplateRef_19_5,this.parentInjector.get(import75.IterableDiffers),this.ref);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import104.TemplateRef) && (19 === requestNodeIndex))) { return this._TemplateRef_19_5; }
    if (((token === import95.NgFor) && (19 === requestNodeIndex))) { return this._NgFor_19_6; }
    if (((token === import93.ItemReorder) && ((17 <= requestNodeIndex) && (requestNodeIndex <= 20)))) { return this._ItemReorder_17_3; }
    if (((token === import94.List) && ((17 <= requestNodeIndex) && (requestNodeIndex <= 20)))) { return this._List_17_4; }
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    changes = null;
    const currVal_7:any = this.context.items;
    if (import83.checkBinding(throwOnChange,this._expr_7,currVal_7)) {
      this._NgFor_19_6.ngForOf = currVal_7;
      if ((changes === null)) { (changes = {}); }
      changes['ngForOf'] = new import85.SimpleChange(this._expr_7,currVal_7);
    ...
    const currVal_6:any = this._ItemReorder_17_3._visibleReorder;
    if (import83.checkBinding(throwOnChange,this._expr_6,currVal_6)) {
      this.renderer.setElementClass(this._el_17,'reorder-visible',currVal_6);
...
export function viewFactory_E2EPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EPage> {
  if ((renderType_E2EPage === null)) { (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/item/test/reorder/main.html',0,import105.ViewEncapsulation.None,styles_E2EPage,{})); }
...
class _View_E2EPage1 extends import81.AppView<any> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._appEl_0 = new import82.AppElement(0,null,this,this._el_0);
    var compView_0:any = import107.viewFactory_Item0(this.viewUtils,this.injector(0),this._appEl_0);
    this._Item_0_4 = new import106.Item(this.parent.parentInjector.get(import32.Form),this.renderer,new import98.ElementRef(this._el_0));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import83.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
      this.renderer.setElementStyle(this._el_0,'background',((this.viewUtils.sanitizer.sanitize(import108.SecurityContext.STYLE,currVal_0) == null)? null: this.viewUtils.sanitizer.sanitize(import108.SecurityContext.STYLE,currVal_0).toString()));
      this._expr_0 = currVal_0;
    }
    const currVal_1:any = (((this.context.$implicit * 2) + 35) + 'px');
    if (import83.checkBinding(throwOnChange,this._expr_1,currVal_1)) {
      this.renderer.setElementStyle(this._el_0,'min-height',((this.viewUtils.sanitizer.sanitize(import108.SecurityContext.STYLE,currVal_1) == null)? null: this.viewUtils.sanitizer.sanitize(import108.SecurityContext.STYLE,currVal_1).toString()));
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/item/test/reorder/AppModule.ts class E2EApp - inline template',0,import105.ViewEncapsulation.None,styles_E2EApp,{})); }
