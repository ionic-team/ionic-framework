...
class _View_E2EPage0 extends import81.AppView<import1.E2EPage> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    var compView_19:any = import101.viewFactory_Item0(this.viewUtils,this.injector(19),this._appEl_19);
    this._Item_19_4 = new import90.Item(this.parentInjector.get(import32.Form),this.renderer,new import96.ElementRef(this._el_19));
    ...
    var compView_27:any = import101.viewFactory_Item0(this.viewUtils,this.injector(27),this._appEl_27);
    this._Item_27_4 = new import90.Item(this.parentInjector.get(import32.Form),this.renderer,new import96.ElementRef(this._el_27));
    ...
    this._appEl_34 = new import82.AppElement(34,27,this,this._el_34);
    var compView_34:any = import102.viewFactory_Button0(this.viewUtils,this.injector(34),this._appEl_34);
    this._Button_34_4 = new import92.Button('',this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_34),this.renderer);
    ...
    var compView_38:any = import101.viewFactory_Item0(this.viewUtils,this.injector(38),this._appEl_38);
    this._Item_38_4 = new import90.Item(this.parentInjector.get(import32.Form),this.renderer,new import96.ElementRef(this._el_38));
    ...
    this._appEl_60 = new import82.AppElement(60,9,this,this._el_60);
    ...
    this._appEl_73 = new import82.AppElement(73,60,this,this._el_73);
    var compView_73:any = import102.viewFactory_Button0(this.viewUtils,this.injector(73),this._appEl_73);
    this._Button_73_4 = new import92.Button('',this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_73),this.renderer);
    ...
    var compView_77:any = import101.viewFactory_Item0(this.viewUtils,this.injector(77),this._appEl_77);
    this._Item_77_4 = new import90.Item(this.parentInjector.get(import32.Form),this.renderer,new import96.ElementRef(this._el_77));
    ...
    this._Icon_96_3 = new import93.Icon(this.parentInjector.get(import66.Config),new import96.ElementRef(this._el_96),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import92.Button) && ((34 <= requestNodeIndex) && (requestNodeIndex <= 35)))) { return this._Button_34_4; }
    if (((token === import90.Item) && ((27 <= requestNodeIndex) && (requestNodeIndex <= 36)))) { return this._Item_27_4; }
    if (((token === import90.ItemContent) && ((27 <= requestNodeIndex) && (requestNodeIndex <= 36)))) { return this._ItemContent_27_5; }
    ...
    if (((token === import90.Item) && ((52 <= requestNodeIndex) && (requestNodeIndex <= 58)))) { return this._Item_52_4; }
    if (((token === import90.ItemContent) && ((52 <= requestNodeIndex) && (requestNodeIndex <= 58)))) { return this._ItemContent_52_5; }
    if (((token === import92.Button) && ((73 <= requestNodeIndex) && (requestNodeIndex <= 74)))) { return this._Button_73_4; }
    if (((token === import90.Item) && ((60 <= requestNodeIndex) && (requestNodeIndex <= 75)))) { return this._Item_60_4; }
    if (((token === import90.ItemContent) && ((60 <= requestNodeIndex) && (requestNodeIndex <= 75)))) { return this._ItemContent_60_5; }
    if (((token === import93.Icon) && (96 === requestNodeIndex))) { return this._Icon_96_3; }
    if (((token === import90.Item) && ((77 <= requestNodeIndex) && (requestNodeIndex <= 97)))) { return this._Item_77_4; }
    if (((token === import90.ItemContent) && ((77 <= requestNodeIndex) && (requestNodeIndex <= 97)))) { return this._ItemContent_77_5; }
    if (((token === import89.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 98)))) { return this._Content_9_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (!throwOnChange) {
      ...
      if (this._query_Icon_77_1.dirty) {
        this._query_Icon_77_1.reset([this._Icon_96_3]);
    ...
    const currVal_5:any = this._Icon_96_3._hidden;
    if (import83.checkBinding(throwOnChange,this._expr_5,currVal_5)) {
      this.renderer.setElementClass(this._el_96,'hide',currVal_5);
...
export function viewFactory_E2EPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EPage> {
  if ((renderType_E2EPage === null)) { (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/item/test/media/main.html',0,import103.ViewEncapsulation.Emulated,styles_E2EPage,{})); }
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/item/test/media/AppModule.ts class E2EApp - inline template',0,import103.ViewEncapsulation.None,styles_E2EApp,{})); }
