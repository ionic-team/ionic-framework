...
class _View_E2EPage0 extends import81.AppView<import1.E2EPage> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._appEl_11 = new import82.AppElement(11,9,this,this._anchor_11);
    this._TemplateRef_11_5 = new import98.TemplateRef_(this._appEl_11,viewFactory_E2EPage1);
    this._NgFor_11_6 = new import90.NgFor(this._appEl_11.vcRef,this._TemplateRef_11_5,this.parentInjector.get(import75.IterableDiffers),this.ref);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import98.TemplateRef) && (11 === requestNodeIndex))) { return this._TemplateRef_11_5; }
    if (((token === import90.NgFor) && (11 === requestNodeIndex))) { return this._NgFor_11_6; }
    if (((token === import89.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 12)))) { return this._Content_9_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (import83.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      ...
      changes['ngForOf'] = new import85.SimpleChange(this._expr_2,currVal_2);
...
export function viewFactory_E2EPage0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EPage> {
  if ((renderType_E2EPage === null)) { (renderType_E2EPage = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/list/test/repeat-headers/main.html',0,import99.ViewEncapsulation.None,styles_E2EPage,{})); }
  return new _View_E2EPage0(viewUtils,parentInjector,declarationEl);
}
class _View_E2EPage1 extends import81.AppView<any> {
  _el_0:any;
  _List_0_3:import100.List;
  _text_1:any;
  _el_2:any;
  private _appEl_2:import82.AppElement;
  _Item_2_4:import101.Item;
  _ListHeader_2_5:import102.ListHeader;
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._List_0_3 = new import100.List(new import93.ElementRef(this._el_0),this.renderer,this.parent.parentInjector.get(import34.GestureController));
    this._text_1 = this.renderer.createText(this._el_0,'\n    ',null);
    this._el_2 = this.renderer.createElement(this._el_0,'ion-list-header',null);
    this._appEl_2 = new import82.AppElement(2,0,this,this._el_2);
    var compView_2:any = import104.viewFactory_Item0(this.viewUtils,this.injector(2),this._appEl_2);
    this._Item_2_4 = new import101.Item(this.parent.parentInjector.get(import32.Form),this.renderer,new import93.ElementRef(this._el_2));
    this._ListHeader_2_5 = new import102.ListHeader(this.renderer,new import93.ElementRef(this._el_2),null);
    ...
    this._TemplateRef_5_5 = new import98.TemplateRef_(this._appEl_5,viewFactory_E2EPage2);
    this._NgFor_5_6 = new import90.NgFor(this._appEl_5.vcRef,this._TemplateRef_5_5,this.parent.parentInjector.get(import75.IterableDiffers),this.parent.ref);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import102.ListHeader) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._ListHeader_2_5; }
    if (((token === import98.TemplateRef) && (5 === requestNodeIndex))) { return this._TemplateRef_5_5; }
    if (((token === import90.NgFor) && (5 === requestNodeIndex))) { return this._NgFor_5_6; }
    if (((token === import100.List) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 6)))) { return this._List_0_3; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    var changes:{[key: string]:import85.SimpleChange} = null;
...
class _View_E2EPage2 extends import81.AppView<any> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._Item_0_4 = new import101.Item(this.parent.parent.parentInjector.get(import32.Form),this.renderer,new import93.ElementRef(this._el_0));
    ...
    this._Icon_4_3 = new import105.Icon(this.parent.parent.parentInjector.get(import66.Config),new import93.ElementRef(this._el_4),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import105.Icon) && (4 === requestNodeIndex))) { return this._Icon_4_3; }
    if (((token === import101.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 6)))) { return this._Item_0_4; }
    if (((token === import101.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 6)))) { return this._ItemContent_0_5; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (!throwOnChange) {
      if (this._query_Icon_0_1.dirty) {
        this._query_Icon_0_1.reset([this._Icon_4_3]);
...
class _View_E2EApp0 extends import81.AppView<import1.E2EApp> {
  ...
  createInternal(rootSelector:string):import82.AppElement {
    ...
    this._Nav_0_4 = new import106.Nav(this.parentInjector.get(import91.ViewController,null),this.parentInjector.get(import108.NavControllerBase,null),this.parentInjector.get(import9.App),this.parentInjector.get(import66.Config),this.parentInjector.get(import35.Keyboard),new import93.ElementRef(this._el_0),this.parentInjector.get(import58.NgZone),this.renderer,this.parentInjector.get(import109.ComponentFactoryResolver),this.parentInjector.get(import34.GestureController),this.parentInjector.get(import44.TransitionController),this.parentInjector.get(import62.DeepLinker,null));
...
export function viewFactory_E2EApp0(viewUtils:import83.ViewUtils,parentInjector:import45.Injector,declarationEl:import82.AppElement):import81.AppView<import1.E2EApp> {
  if ((renderType_E2EApp === null)) { (renderType_E2EApp = viewUtils.createRenderComponentType('/Users/dan/Dev/ionic2-build/src/components/list/test/repeat-headers/AppModule.ts class E2EApp - inline template',0,import99.ViewEncapsulation.None,styles_E2EApp,{})); }
