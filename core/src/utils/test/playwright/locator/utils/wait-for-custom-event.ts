...
import { E2ELocator } from '../../playwright-declarations';

/**
 * Waits for a custom event to be dispatched on an element handle. Fails after 5000ms without an event emission.
 */
export function waitForCustomEvent(originalFn: (...args: any[]) => Locator, selector: string, options?: { has?: Locator | undefined; hasText?: string | RegExp | undefined; } | undefined): E2ELocator {
