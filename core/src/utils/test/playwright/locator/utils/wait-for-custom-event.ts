 ...
 */
export const waitForCustomEvent = (originalFn: (...args: any[]) => Locator, selector: string, options?: { has?: Locator | undefined; hasText?: string | RegExp | undefined; } | undefined): E2ELocator => {
