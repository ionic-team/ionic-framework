import { copyLayoutViewport, copyVisualViewport, setKeyboardClose, setKeyboardOpen, keyboardDidClose, keyboardDidOpen, keyboardDidResize, resetKeyboardAssist, startKeyboardAssist, trackViewportChanges, KeyboardLifeCycle } from '../';
...
describe('Keyboard Assist Tests', () => {
  ...
  describe('setKeyboardOpen()', () => {
    it('should dispatch the keyboard open event on the window', () => {       
      ...
      expect(window.dispatchEvent.mock.calls[0][0].type).toEqual(KeyboardLifeCycle.Open);
    });
  });
  ...
  describe('setKeyboardClose()', () => {
    it('should dispatch the keyboard close event on the window', () => {       
      ...
      expect(window.dispatchEvent.mock.calls.length).toEqual(1);
      expect(window.dispatchEvent.mock.calls[0][0].type).toEqual(KeyboardLifeCycle.Close);
    });
  });
...
describe('Keyboard Assist Integration', () => {
  ...
  it('should properly set the keyboard to be closed', () => {
    ...
    expect(window.dispatchEvent.mock.calls[1][0].type).toEqual(KeyboardLifeCycle.Close);
  });
  ...
  it('should properly set the keyboard to be resized', () => {
    ...
    expect(window.dispatchEvent.mock.calls.length).toEqual(2);
    expect(window.dispatchEvent.mock.calls[0][0].type).toEqual(KeyboardLifeCycle.Open);
    expect(window.dispatchEvent.mock.calls[1][0].type).toEqual(KeyboardLifeCycle.Open);
  });
