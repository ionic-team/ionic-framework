...
export type AnimationKeyFrames =
  ...
  | AnimationKeyFrame[];
export type AnimationStyles = Record<
  string,
  any
>;
...
export interface AnimationKeyFrameEdge
  extends AnimationStyles {
  offset?: number;
}
