...
declare namespace LocalJSX {
    ...
    interface IonDatetime {
        ...
        /**
          * Emitted when a wheel column inside the datetime finishes scrolling and the value has settled. Does not bubble to avoid duplicate handling alongside inner column events.
         */
        "onIonScrollEnd"?: (event: IonDatetimeCustomEvent<void>) => void;
        /**
          * Emitted when a wheel column inside the datetime begins scrolling. Does not bubble to avoid duplicate handling alongside inner column events.
         */
        "onIonScrollStart"?: (event: IonDatetimeCustomEvent<void>) => void;
        /**
    ...
    interface IonPickerColumn {
         ...
         */
        "onIonScrollEnd"?: (event: IonPickerColumnCustomEvent<void>) => void;
        /**
          * Emitted when the user begins scrolling the wheel.
         */
        "onIonScrollStart"?: (event: IonPickerColumnCustomEvent<void>) => void;
        /**
          * The selected option in the picker.
         */
        "value"?: string | number;
