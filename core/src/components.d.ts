...
export namespace Components {
    ...
    interface IonAvatar {
        ...
        /**
          * Set to `"xxsmall"` for an smallest size. Set to `"xsmall"` for a very small size. Set to `"small"` for a compact size. Set to `"medium"` for the default height and width. Set to `"large"` for a larger size. Set to `"xlarge"` for the largest dimensions.  Defaults to `"medium"` for the `ionic` theme, undefined for all other themes.
         */
