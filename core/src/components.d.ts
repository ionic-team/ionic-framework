...
export namespace Components {
    ...
    interface IonDatetime {
         ...
         */
        "enterInputMode": (scope?: "all" | "hour" | "minute", options?: { focus?: boolean; }) => Promise<void>;
        /**
          * Programmatically exit numeric input mode for wheel pickers. Only applicable when a time picker with numeric columns is rendered (presentations: "time", "date-time", or "time-date").
         */
    ...
    interface IonPicker {
         ...
         */
        "enterInputMode": (columnEl?: HTMLIonPickerColumnElement, focusInput?: boolean) => Promise<void>;
        "exitInputMode": () => Promise<void>;
        /**
          * The mode determines which platform styles to use.
         */
...
declare global {
    ...
    interface HTMLIonDatetimeElementEventMap {
        "inputModeChanged": { active: boolean };
        "ionCancel": void;
...
declare namespace LocalJSX {
    ...
    interface IonDatetime {
         ...
         */
        "onInputModeChanged"?: (event: IonDatetimeCustomEvent<{ active: boolean }>) => void;
        /**
