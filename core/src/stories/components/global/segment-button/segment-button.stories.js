...
export default {
  title: 'Components/Core/Segment Button',
    ...
    <ion-app>
      <ion-content>
        ...
        <ion-segment .dsColor=${dsColor} ds-name=${dsName} (ionChange)="segmentChanged($event)">
          ...
          <ion-segment-button .dsColor=${dsColor} ds-name=${dsName} value="away">
...
export const segmentButton = TemplateDefault.bind({});
segmentButton.parameters = {
  design: {
    type: 'figma',
    url: 'https://www.figma.com/file/2j9jNt3PmQXpzD3IQJkyZe/Componentes?node-id=3644%3A22',
  },
}
segmentButton.argTypes = {
  dsColor: {
    options: MedColor,
    control: { type: 'select'},
