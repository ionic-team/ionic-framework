  ...
  implements ComponentInterface
{
    ...
    if (hasCondense) {
      ...
      writeTask(() => {
        const title = cloneElement(
          'ion-title'
        ) as HTMLIonTitleElement;
        title.size = 'large';
        cloneElement('ion-back-button');
      });

      await this.setupCondenseHeader(
        contentEl,
        pageEl
      );
    } else if (hasFade) {
  ...
  private async setupCondenseHeader(
    ...
    if (
      typeof (IntersectionObserver as any) ===
      'undefined'
    ) {
      return;
    }
    ...
    const scrollHeaderIndex =
      createHeaderIndex(this.el);
