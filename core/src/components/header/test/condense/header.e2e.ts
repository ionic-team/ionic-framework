...
configs({
  ...
  ({ title, screenshot, config }) => {
    test.describe(
      ...
      () => {
        test('should be hidden from screen readers when collapsed', async ({
          page,
        }) => {
          await page.goto(
            '/src/components/header/test/condense',
            config
          );
          ...
          await expect(
            ...
            screenshot(
              `header-condense-large-title-initial-diff`
            )
          );
          ...
          await page
            .locator(
              '#largeTitleHeader.header-collapse-condense-inactive'
            )
            .waitFor();
           ...
           */
          const ariaHidden =
            await smallTitleHeader.getAttribute(
              'aria-hidden'
            );
          ...
          await page
            .locator(
              '#smallTitleHeader.header-collapse-condense-inactive'
            )
            .waitFor();
