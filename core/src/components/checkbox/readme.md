...
| ----------- | ---------------------------------------------- | ------------------- |
| `ionBlur`   | Emitted when the toggle loses focus.           | `CustomEvent<TODO>` |
| `ionChange` | Emitted when the checked property has changed. | `CustomEvent<TODO>` |
| `ionFocus`  | Emitted when the toggle has focus.             | `CustomEvent<TODO>` |
