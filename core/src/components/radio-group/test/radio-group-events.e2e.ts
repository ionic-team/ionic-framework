...
configs({
  ...
  test.describe(
    title(
      'radio group: events: ionChange'
    ),
    () => {
      test('should emit when selecting an unchecked radio', async ({
        page,
      }) => {
    ...
    `,
      ...
      test('should emit when the radio group does not have an initial value', async ({
        page,
      }) => {
        await page.setContent(
          `
    ...
    `,
      ...
      test('should not emit when selecting a checked radio', async ({
        page,
      }) => {
        await page.setContent(
          `
    ...
    `,
      ...
      test.describe(
        'allowEmptySelection',
        () => {
          test('should emit when selecting a checked radio', async ({
            page,
          }) => {
            await page.setContent(
              `
