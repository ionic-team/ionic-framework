...
| `closeButtonIcon` | `close-button-icon` | Set the close button icon which appears when this button is used as a main fab-button inside a `ion-fab` with a `fab-list`.                                                                                                                                                               | `string`                          | `'close'`   |
