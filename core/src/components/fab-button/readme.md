...
| `closeIcon`       | `close-icon`       | The icon name to use for the close icon which appears on click when the fab button is the main button in a fab containing a fab list.                                                                                                                                                     | `string`                          | `'close'`   |
