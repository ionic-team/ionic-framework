  ...
  implements ComponentInterface
{
   ...
   */
  @Prop()
  value = `ion-accordion-${accordionIds++}`;
  @Watch('value')
  valueChanged() {
    this.updateState();
  }
  ...
  connectedCallback() {
    const accordionGroupEl =
      (this.accordionGroupEl =
        this.el?.closest(
          'ion-accordion-group'
        ));
    if (accordionGroupEl) {
  ...
  private slotToggleIcon = () => {
     ...
     */
    const existingToggleIcon =
      ionItem.querySelector(
  ...
  private shouldAnimate = () => {
    ...
    if (
      this.accordionGroupEl &&
      !this.accordionGroupEl.animated
    ) {
      return false;
    }
  ...
  private updateState = async (
    ...
    const shouldExpand = Array.isArray(
      value
    )
    ...
    if (shouldExpand) {
      ...
      if (
        nextAccordionValue !== undefined
      ) {
        this.isPrevious = Array.isArray(
          value
        )
          ? value.includes(
              nextAccordionValue
  ...
  private toggleExpanded() {
    ...
    if (accordionGroupEl) {
      ...
      const expand =
        ...
        state ===
          AccordionState.Collapsing;
      accordionGroupEl.requestAccordionToggle(
        value,
        expand
      );
    }
  ...
  render() {
    ...
    const expanded =
      ...
      this.state ===
        AccordionState.Expanding;
    const headerPart = expanded
      ? 'header expanded'
      : 'header';
    const contentPart = expanded
      ? 'content expanded'
      : 'content';
