...
configs({
  ...
  ({ title, screenshot, config }) => {
    test.describe(
      title(
        'toggle: item color contrast'
      ),
      () => {
        test('label should have correct contrast when used in an item', async ({
          page,
        }) => {
          await page.setContent(
            `
...
configs({
  ...
  ({ title, screenshot, config }) => {
    ...
    test.describe(
      title('toggle: ionChange'),
      () => {
        test('clicking padded space within item should click the toggle', async ({
          page,
        }) => {
          await page.setContent(
            `
