...
<ion-list>
  ...
  <ion-item-sliding>
    ...
    <ion-item-options>
      <ion-item-option color="primary">
        <ion-icon slot="top" name="ellipsis-vertical"></ion-icon>
        More
      </ion-item-option>
      <ion-item-option color="secondary">
  ...
  <ion-item-sliding>
    ...
    <ion-item-options>
      <ion-item-option color="primary">
        <ion-icon slot="bottom" name="ellipsis-vertical"></ion-icon>
        More
      </ion-item-option>
      <ion-item-option color="secondary">
...
<IonList>
  ...
  <IonItemSliding>
    ...
    <IonItemOptions>
      <IonItemOption color="primary">
        <IonIcon slot="start" name="ellipsis-vertical"></IonIcon>
        More
      </IonItemOption>
  ...
  <IonItemSliding>
    ...
    <IonItemOptions>
      <IonItemOption color="primary">
        <IonIcon slot="end" name="ellipsis-vertical"></IonIcon>
        More
      </IonItemOption>
      <IonItemOption color="secondary">
  ...
  <IonItemSliding>
    ...
    <IonItemOptions>
      <IonItemOption color="primary">
        <IonIcon slot="top" name="ellipsis-vertical"></IonIcon>
        More
      </IonItemOption>
      <IonItemOption color="secondary">
  ...
  <IonItemSliding>
    ...
    <IonItemOptions>
      <IonItemOption color="primary">
        <IonIcon slot="bottom" name="ellipsis-vertical"></IonIcon>
        More
      </IonItemOption>
      <IonItemOption color="secondary">
