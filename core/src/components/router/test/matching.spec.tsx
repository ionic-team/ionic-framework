...
describe('matchesIDs', () => {
  it('should match simple set of ids', () => {
    ...
    expect(matchesIDs([], chain)).toBe(
      0
    );
    expect(
      matchesIDs([{ id: '1' }], chain)
    ).toBe(0);
  });
...
describe('matchesSegments', () => {
  it('should match simple path', () => {
    ...
    expect(
      matchesSegments([], chain)
    ).toEqual(null);
    expect(
      matchesSegments([''], chain)
    ).toEqual(null);
    expect(
      matchesSegments(['path'], chain)
    ).toEqual(null);
  });
  ...
  it('should match with parameters', () => {
    ...
    const matched = matchesSegments(
      parsePath(
        '/profile/manu/image/image/large/retina'
      ).segments,
      chain
    );
...
describe('findChainForSegments', () => {
  ...
  it('should match the route with higher priority 2', () => {
    ...
    const chain7: RouteChain = [
      {
        id: '7',
        segments: ['workouts', 'list'],
        params: undefined,
      },
    ];
...
describe('mergeParams', () => {
  it('should merge undefined', () => {
    expect(
      mergeParams(undefined, undefined)
    ).toBeUndefined();
    expect(
      mergeParams(
        null as any,
  ...
  it('should merge undefined with params', () => {
    const params = { data: '1' };
    expect(
      mergeParams(undefined, params)
    ).toEqual(params);
    expect(
      mergeParams(null as any, params)
    ).toEqual(params);
    expect(
      mergeParams(params, undefined)
    ).toEqual(params);
    expect(
      mergeParams(params, null as any)
    ).toEqual(params);
  });
