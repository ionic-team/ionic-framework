...
| `component`      | `component` | Name of the component to load/select in the navigation outlet (`ion-tab-view`, `ion-nav`) when the route matches.  The value of this property is not always the tagname of the component to load, in `ion-tab-group` it actually refers to the name of the `ion-tab-view` to select. | `string`                               |
