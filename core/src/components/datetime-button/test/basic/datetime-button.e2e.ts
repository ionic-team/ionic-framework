...
configs({ modes: ['md'], directions: ['ltr'] }).forEach(({ title, config }) => {
  test.describe('datetime-button: switching to correct view', () => {
    ...
    test(title('should switch to a date-only view when the date button is clicked'), async ({ page }) => {
    ...
    test(title('should switch to a time-only view when the time button is clicked'), async ({ page }) => {
      const datetime = page.locator('ion-datetime');
      expect(datetime).toHaveJSProperty('presentation', 'date-time');
...
configs({ modes: ['md'], directions: ['ltr'] }).forEach(({ title, config }) => {
  test.describe('datetime-button: labels', () => {
    test(title('should set date and time labels in separate buttons'), async ({ page }) => {
      await page.setContent(
        `
    ...
    test(title('should set only month and year'), async ({ page }) => {
      await page.setContent(
        `
        <ion-datetime-button locale="en-US" datetime="datetime"></ion-datetime-button>
    ...
    test(title('should set only year'), async ({ page }) => {
      await page.setContent(
        `
        <ion-datetime-button locale="en-US" datetime="datetime"></ion-datetime-button>
    ...
    test(title('should set only month'), async ({ page }) => {
      await page.setContent(
        `
        <ion-datetime-button locale="en-US" datetime="datetime"></ion-datetime-button>
    ...
    test(title('should set only time'), async ({ page }) => {
      await page.setContent(
        `
        <ion-datetime-button locale="en-US" datetime="datetime"></ion-datetime-button>
    ...
    test(title('should update the label when the value of the datetime changes'), async ({ page }) => {
      await page.setContent(
        `
        <ion-datetime-button locale="en-US" datetime="datetime"></ion-datetime-button>
...
configs({ modes: ['md'], directions: ['ltr'] }).forEach(({ title, config }) => {
  test.describe('datetime-button: locale', () => {
    test(title('should use the same locale as datetime'), async ({ page }) => {
      await page.setContent(
        `
        <ion-datetime-button datetime="datetime"></ion-datetime-button>
    ...
    test(title('should respect hour cycle even if different from locale default'), async ({ page }) => {
      await page.setContent(
        `
        <ion-datetime-button datetime="datetime"></ion-datetime-button>
    ...
    test(title('should ignore the timezone when selecting a date'), async ({ page }) => {
      await page.setContent(
        `
        <ion-datetime-button datetime="datetime"></ion-datetime-button>
...
configs({ modes: ['md'], directions: ['ltr'] }).forEach(({ title, config }) => {
  test.describe('datetime-button: wheel', () => {
    test(
      title('should only show a single date button when presentation="date-time" and prefer-wheel="true"'),
      async ({ page }) => {
        await page.setContent(
          `
        <ion-datetime-button datetime="datetime"></ion-datetime-button>
    ...
    test(
      title('should only show a single date button when presentation="time-date" and prefer-wheel="true"'),
      async ({ page }) => {
        await page.setContent(
          `
        <ion-datetime-button datetime="datetime"></ion-datetime-button>
