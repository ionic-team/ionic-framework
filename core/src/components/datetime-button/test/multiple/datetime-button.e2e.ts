...
configs({ modes: ['md'], directions: ['ltr'] }).forEach(({ title, config }) => {
  test.describe('datetime-button: multiple selection', () => {
    test(title('should render number of dates when more than 1 date is selected'), async ({ page }) => {
    ...
    test(title('should render number of dates when 0 dates are selected'), async ({ page }) => {
      await page.setContent(
        `
        <ion-datetime-button datetime="datetime"></ion-datetime-button>
        <ion-datetime locale="en-US" id="datetime" presentation="date" multiple="true"></ion-datetime>
    ...
    test(title('should render date when only 1 day is selected'), async ({ page }) => {
      await page.setContent(
        `
        <ion-datetime-button datetime="datetime"></ion-datetime-button>
        <ion-datetime locale="en-US" id="datetime" presentation="date" multiple="true"></ion-datetime>
    ...
    test(title('should use customFormatter'), async ({ page }) => {
      await page.setContent(
        `
        <ion-datetime-button datetime="datetime"></ion-datetime-button>
        <ion-datetime locale="en-US" id="datetime" presentation="date" multiple="true"></ion-datetime>
    ...
    test(title('should re-render when value is programmatically changed'), async ({ page }) => {
      await page.setContent(
        `
        <ion-datetime-button datetime="datetime"></ion-datetime-button>
        <ion-datetime locale="en-US" id="datetime" presentation="date" multiple="true"></ion-datetime>
    ...
    test(title('should render single date if datetime is used incorrectly'), async ({ page }) => {
      await page.setContent(
        `
        <ion-datetime-button datetime="datetime"></ion-datetime-button>
