    ...
    test.describe(
      ...
      () => {
        test('should not have any axe violations', async ({
          ...
          await page.goto(
            '/src/components/segment/test/a11y',
            config
          );
        ...
        test('segment buttons should be keyboard navigable', async ({
          page,
          pageUtils,
        }) => {
          const isRTL =
