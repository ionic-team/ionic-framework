...
| `keyboardBehavior` | `keyboard-behavior` | If `select`, navigating to an `ion-segment-button` with the keyboard will focus and select the element. If `focus`, keyboard navigation will only focus the `ion-segment-button` element.                                                                              | `"focus" \| "select" \| undefined` | `'focus'`   |
