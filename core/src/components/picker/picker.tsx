    ...
    OverlayInterface
{
   ...
   */
  @Event({
    eventName: 'ionPickerWillPresent',
  })
   ...
   */
  @Event({
    eventName: 'ionPickerWillDismiss',
  })
  ...
  getColumn(
    name: string
  ): Promise<PickerColumn | undefined> {
