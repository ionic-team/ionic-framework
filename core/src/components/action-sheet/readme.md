...
| ----------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------- | --------------------------------- | ----------- |
| `animated`        | `animated`         | If `true`, the action sheet will animate. Defaults to `true`.                                                    | `boolean`                         | `true`      |
| `backdropDismiss` | `backdrop-dismiss` | If `true`, the action sheet will be dismissed when the backdrop is clicked. Defaults to `true`.                  | `boolean`                         | `true`      |
...
| `translucent`     | `translucent`      | If `true`, the action sheet will be translucent. Defaults to `false`.                                            | `boolean`                         | `false`     |
