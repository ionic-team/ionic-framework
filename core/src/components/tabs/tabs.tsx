import type { NavOutlet, RouteID, RouteWrite } from '@components/router/utils/interface';
import type { TabButtonClickEventDetail } from '@components/tab-bar/tab-bar-interface';
