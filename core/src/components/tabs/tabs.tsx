...
export class Tabs implements NavOutlet {
  ...
  private onTabClicked = (
    ev: CustomEvent<TabButtonClickEventDetail>
  ) => {
...
const getTab = (
  ...
  if (!tabEl) {
    console.error(
      `tab with id: "${tabEl}" does not exist`
    );
  }
  return tabEl;
};
