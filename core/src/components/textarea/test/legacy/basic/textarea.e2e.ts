    ...
    test.describe(
      ...
      () => {
        test('should not have visual regressions', async ({
          ...
          await page.goto(
            `/src/components/textarea/test/legacy/basic`,
            config
          );
          ...
          await expect(
            ...
            screenshot(`textarea-diff`)
          );
        });

        test.describe(
          title('with floating labels'),
          () => {
            /**
        ...
        <ion-item>
          ...
          <ion-textarea></ion-textarea>
              ...
              await expect(
                ...
                screenshot(
                  `textarea-floating-label-initial`
                )
              );
