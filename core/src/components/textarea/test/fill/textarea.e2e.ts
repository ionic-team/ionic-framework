      ...
      () => {
        ...
        `,
              ...
              await expect(
                ...
                screenshot(
                  `textarea-fill-solid-label-floating`
                )
              );
            });
        ...
        `,
              ...
              await expect(
                ...
                screenshot(
                  `textarea-fill-shaped-solid-custom`
                )
              );
            });
          }
        ...
        `,
              ...
              await expect(
                ...
                screenshot(
                  `textarea-fill-outline-label-floating`
                )
              );
            });
  ...
  test.describe(
    ...
    () => {
      ...
      `,
        ...
        const notchCutout =
          page.locator(
            'ion-textarea .textarea-outline-notch'
          );
        await expect(
          notchCutout
        ).toBeHidden();
    ...
    test.describe(
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `textarea-fill-outline-slotted-label`
            )
          );
        });
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `textarea-fill-outline-hidden-slotted-label`
            )
          );
        });
      }
