      ...
      () => {
        ...
        `,
              ...
              await expect(
                ...
                screenshot(
                  `textarea-no-fill-color-floating`
                )
              );
            });
        ...
        `,
              ...
              await expect(
                ...
                screenshot(
                  `textarea-no-fill-color-stacked`
                )
              );
            });
          }
        ...
        `,
              ...
              await expect(
                ...
                screenshot(
                  `textarea-outline-color-floating`
                )
              );
            });
            test('should set label and highlight color on focus with stacked label placement', async ({
        ...
        `,
              ...
              await expect(
                ...
                screenshot(
                  `textarea-outline-color-stacked`
                )
              );
            });
          }
