...
| `debounce`  | `debounce`   | How long, in milliseconds, to wait to trigger the `ionChange` event after each change in the range value. Default `0`.                                                                                                                                                 | `number`                                      | `0`         |
| `disabled`  | `disabled`   | If `true`, the user cannot interact with the range. Defaults to `false`.                                                                                                                                                                                               | `boolean`                                     | `false`     |
| `dualKnobs` | `dual-knobs` | Show two knobs. Defaults to `false`.                                                                                                                                                                                                                                   | `boolean`                                     | `false`     |
| `max`       | `max`        | Maximum integer value of the range. Defaults to `100`.                                                                                                                                                                                                                 | `number`                                      | `100`       |
| `min`       | `min`        | Minimum integer value of the range. Defaults to `0`.                                                                                                                                                                                                                   | `number`                                      | `0`         |
| `mode`      | `mode`       | The mode determines which platform styles to use.                                                                                                                                                                                                                      | `"ios" \| "md"`                               | `undefined` |
| `name`      | `name`       | The name of the control, which is submitted with the form data.                                                                                                                                                                                                        | `string`                                      | `''`        |
| `pin`       | `pin`        | If `true`, a pin with integer value is shown when the knob is pressed. Defaults to `false`.                                                                                                                                                                            | `boolean`                                     | `false`     |
| `snaps`     | `snaps`      | If `true`, the knob snaps to tick marks evenly spaced based on the step property value. Defaults to `false`.                                                                                                                                                           | `boolean`                                     | `false`     |
| `step`      | `step`       | Specifies the value granularity. Defaults to `1`.                                                                                                                                                                                                                      | `number`                                      | `1`         |
