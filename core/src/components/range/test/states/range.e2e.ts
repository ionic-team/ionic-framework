    ...
    test.describe(
      ...
      `,
          ...
          await expect(
            ...
            screenshot(`range-disabled`)
          );
        });

        test('should render disabled state with a value', async ({
          page,
        }) => {
          await page.setContent(
            `
      ...
      `,
        ...
        test('should render disabled state with ticks', async ({
          page,
        }) => {
          await page.setContent(
            `
