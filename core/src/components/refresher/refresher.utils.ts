...
const createBaseAnimation = (
  pullingRefresherIcon: HTMLElement
) => {
  const spinner =
    pullingRefresherIcon.querySelector(
      'ion-spinner'
    )!;
  const circle =
    spinner!.shadowRoot!.querySelector(
      'circle'
    )!;
  const spinnerArrowContainer =
    pullingRefresherIcon.querySelector(
  ...
  const spinnerArrowContainerAnimation =
    createAnimation()
...
export const createSnapBackAnimation = (
  pullingRefresherIcon: HTMLElement
) => {
...
export const setSpinnerOpacity = (
  spinner: HTMLElement,
  opacity: number
) => {
...
export const translateElement = (
  ...
  const trans = transitionEndAsync(
    el,
    duration
  );
...
export const shouldUseNativeRefresher =
  async (
    referenceEl: HTMLIonRefresherElement,
    mode: string
  ) => {
    const refresherContent =
      referenceEl.querySelector(
