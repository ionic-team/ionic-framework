...
| ----------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- | ----------- |
| `animated`        | `animated`          | If `true`, the toast will animate. Defaults to `true`.                                                                                                                                                                                                                 | `boolean`                         | `true`      |
...
| `showCloseButton` | `show-close-button` | If `true`, the close button will be displayed. Defaults to `false`.                                                                                                                                                                                                    | `boolean`                         | `false`     |
| `translucent`     | `translucent`       | If `true`, the toast will be translucent. Defaults to `false`.                                                                                                                                                                                                         | `boolean`                         | `false`     |
