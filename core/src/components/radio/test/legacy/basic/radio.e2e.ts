...
configs().forEach(
  ({ title, screenshot, config }) => {
    test.describe(
      ...
      () => {
        test('should correctly render an unchecked radio group', async ({
          page,
        }) => {
      ...
      `,
        ...
        test('should correctly render a checked radio group', async ({
          page,
        }) => {
          await page.setContent(
            `
      ...
      `,
        ...
        test('should allow shadow parts to be styled', async ({
          page,
        }) => {
          await page.setContent(
            `
...
configs({
  ...
  test.describe(
    title('radio: interaction'),
    () => {
      test('radio should be checked when activated', async ({
        page,
      }) => {
        await page.setContent(
          `
      ...
      test('radio should be checked when activated even without a radio group', async ({
        page,
      }) => {
        await page.setContent(
          `
