  ...
  implements ComponentInterface
{
  ...
  private radioGroup: HTMLIonRadioGroupElement | null =
    null;
        ...
        class={createColorClasses(
          color,
          {
            ...
            [`radio-alignment-${alignment}`]:
              true,
            [`radio-label-placement-${labelPlacement}`]:
              true,
