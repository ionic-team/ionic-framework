...
Example: <ion-radio>Email:</ion-radio>
For toggles that do not have a visible label, developers should use "aria-label" so screen readers can announce the purpose of the radio.`,
        this.el
      );
