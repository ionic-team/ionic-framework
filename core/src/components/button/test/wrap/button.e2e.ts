...
configs({
  ...
  ({ title, screenshot, config }) => {
    test.describe(
      title('button: wrap'),
      () => {
        test('should render button with long text', async ({
          page,
        }) => {
      ...
      `,
          ...
          await expect(
            ...
            screenshot(`button-wrap`)
          );
        });

        test('should render small button with long text', async ({
          page,
        }) => {
          // TODO(FW-4599): remove ion-text-wrap class
          await page.setContent(
      ...
      `,
        ...
        test('should render large button with long text', async ({
          page,
        }) => {
          // TODO(FW-4599): remove ion-text-wrap class
          await page.setContent(
      ...
      `,
        ...
        test('should render button with long text and icons', async ({
          page,
        }) => {
          // TODO(FW-4599): remove ion-text-wrap class
          await page.setContent(
      ...
      `,
        ...
        test('should render block button with long text', async ({
          page,
        }) => {
          // TODO(FW-4599): remove ion-text-wrap class
          await page.setContent(
      ...
      `,
        ...
        test('should render block button with long text and icons', async ({
          page,
        }) => {
          // TODO(FW-4599): remove ion-text-wrap class
          await page.setContent(
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `button-wrap-block-icons`
            )
          );
        });

        test('should render full button with long text', async ({
          page,
        }) => {
          // TODO(FW-4599): remove ion-text-wrap class
          await page.setContent(
      ...
      `,
        ...
        test('should render full button with long text and icons', async ({
          page,
        }) => {
          // TODO(FW-4599): remove ion-text-wrap class
          await page.setContent(
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `button-wrap-full-icons`
            )
          );
        });

        test('should render an item button with long text', async ({
          page,
        }) => {
          // TODO(FW-4599): remove ion-text-wrap class
          await page.setContent(
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `button-wrap-item-button`
            )
          );
        });

        test('should render an item button with long text and icons', async ({
          page,
        }) => {
          // TODO(FW-4599): remove ion-text-wrap class
          await page.setContent(
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `button-wrap-item-button-icons`
            )
          );
        });

        test('should render a list header button with long text', async ({
          page,
        }) => {
          // TODO(FW-4599): remove ion-text-wrap class
          await page.setContent(
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `button-wrap-list-header-button`
            )
          );
        });

        test('should render a toolbar button with long text', async ({
          page,
        }) => {
          // TODO(FW-4599): remove ion-text-wrap class
          await page.setContent(
