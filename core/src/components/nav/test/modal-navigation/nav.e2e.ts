...
configs().forEach(({ title, config }) => {
  test.describe('nav: modal-navigation', () => {
    ...
    test(title('should render the root page'), async ({ page }) => {
    ...
    test(title('should push to the next page'), async ({ page }) => {
    ...
    test(title('should pop to the previous page'), async ({ page }) => {
      await page.click('#goto-page-two');
