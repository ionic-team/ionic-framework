...
describe('NavController', () => {
  describe('push and pop', () => {
    it('should push multiple times and pop multiple times', async () => {
      ...
      expect(nav.getLength()).toEqual(
        1
      );
      expect(
        nav['views'][0].component
      ).toEqual(MockView1);
  ...
  describe('push', () => {
    ...
    it('should push a ViewController as the second view and fire lifecycles', async () => {
      ...
      const instance1 =
        spyOnLifecycles(view1);
      const instance2 =
        spyOnLifecycles(view2);
      ...
      expect(
        instance1.ionViewDidEnter
      ).not.toHaveBeenCalled();
      expect(
        instance1.ionViewWillLeave
      ).toHaveBeenCalled();
      expect(
        instance1.ionViewDidLeave
      ).toHaveBeenCalled();
      expect(
        instance1.ionViewWillUnload
      ).not.toHaveBeenCalled();

      expect(
        instance2.ionViewWillEnter
      ).toHaveBeenCalled();
      expect(
        instance2.ionViewDidEnter
      ).toHaveBeenCalled();
      expect(
        instance2.ionViewWillLeave
      ).not.toHaveBeenCalled();
      expect(
        instance2.ionViewDidLeave
      ).not.toHaveBeenCalled();
      expect(
        instance2.ionViewWillUnload
      ).not.toHaveBeenCalled();
  ...
  describe('insert', () => {
    it('should insert at the beginning with no async transition', async () => {
      ...
      expect(
        instance4.ionViewWillEnter
      ).not.toHaveBeenCalled();
      expect(
        instance4.ionViewDidEnter
      ).not.toHaveBeenCalled();
      expect(
        instance4.ionViewWillLeave
      ).not.toHaveBeenCalled();
      expect(
        instance4.ionViewDidLeave
      ).not.toHaveBeenCalled();
      expect(
        instance4.ionViewWillUnload
      ).not.toHaveBeenCalled();
  ...
  describe('popTo', () => {
    ...
    it('should pop to first using an index number', async () => {
      ...
      expect(
        instance3.ionViewWillEnter
      ).not.toHaveBeenCalled();
      expect(
        instance3.ionViewDidEnter
      ).not.toHaveBeenCalled();
      expect(
        instance3.ionViewWillLeave
      ).toHaveBeenCalled();
      expect(
        instance3.ionViewDidLeave
      ).toHaveBeenCalled();
      expect(
        instance3.ionViewWillUnload
      ).toHaveBeenCalled();
  ...
  describe('remove', () => {
    ...
    it('should remove two views in the middle', async () => {
      ...
      expect(
        instance5.ionViewWillEnter
      ).not.toHaveBeenCalled();
      expect(
        instance5.ionViewDidEnter
      ).not.toHaveBeenCalled();
      expect(
        instance5.ionViewWillLeave
      ).not.toHaveBeenCalled();
      expect(
        instance5.ionViewDidLeave
      ).not.toHaveBeenCalled();
      expect(
        instance5.ionViewWillUnload
      ).not.toHaveBeenCalled();
  ...
  function spyOnLifecycles(
    ...
    const instance = {
      ionViewWillEnter: jest.spyOn(
        element,
        'ionViewWillEnter'
      ),
      ionViewDidEnter: jest.spyOn(
        element,
        'ionViewDidEnter'
      ),
      ionViewWillLeave: jest.spyOn(
        element,
        'ionViewWillLeave'
      ),
      ionViewDidLeave: jest.spyOn(
        element,
        'ionViewDidLeave'
      ),
      ionViewWillUnload: jest.spyOn(
        element,
        'ionViewWillUnload'
      ),
    };
