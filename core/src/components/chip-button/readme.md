...
| `disabled` | `disabled` | If `true`, the user cannot interact with the chip button.                                                                                                                                                                                                              | `boolean`             |
| `fill`     | `fill`     | Set to `"clear"` for a transparent button or to `"solid"` for a filled background.                                                                                                                                                                                     | `"clear" \| "solid"`  |
