...
configs().forEach(
  ({ title, screenshot, config }) => {
    test.describe(
      ...
      () => {
        test('label should appear on the starting side of the input', async ({
          page,
        }) => {
    ...
    test.describe(
      ...
      () => {
        test('label should appear on the ending side of the input', async ({
          page,
        }) => {
          await page.setContent(
            `
    ...
    test.describe(
      ...
      () => {
        test('label should appear above the input when there is a value', async ({
          page,
        }) => {
          await page.setContent(
            `
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `input-placement-stacked-value`
            )
          );
        });
        test('label should appear above the input when there is a no value', async ({
          page,
        }) => {
          await page.setContent(
            `
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `input-placement-stacked-no-value`
            )
          );
        });
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `input-placement-stacked-long-label`
            )
          );
        });
      }
    ...
    test.describe(
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `input-placement-floating-value`
            )
          );
        });
        test('label should appear on top of the input and hide the input when there is a no value', async ({
          page,
        }) => {
          await page.setContent(
            `
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `input-placement-floating-no-value`
            )
          );
        });
        test('label should appear on top of the input when the input is focused', async ({
          page,
        }) => {
          await page.setContent(
            `
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `input-focused-placement-floating-no-value`
            )
          );
        });
        test('long label should truncate', async ({
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `input-placement-floating-long-label`
            )
          );
        });
      }
...
configs({ modes: ['md'] }).forEach(
  ({ title, screenshot, config }) => {
    test.describe(
      title('input: label with fill'),
      () => {
        test('long label should truncate with outline', async ({
          page,
        }) => {
          await page.setContent(
            `
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `input-placement-floating-long-label-outline`
            )
          );
        });
        test('long label should truncate with solid', async ({
          page,
        }) => {
          await page.setContent(
            `
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `input-placement-floating-long-label-solid`
            )
          );
        });
      }
...
configs({
  ...
  ({ title, screenshot, config }) => {
    ...
    test.describe(
      title('input: async label'),
      () => {
        test('input should re-render when label slot is added async', async ({
          page,
        }) => {
          await page.setContent(
            `
    ...
    test.describe(
      title(
        'input: floating/stacked label layering'
      ),
      () => {
