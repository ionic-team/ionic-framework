      ...
      () => {
        ...
        `,
              ...
              await expect(
                ...
                screenshot(
                  `input-with-lines-inset-focused`
                )
              );
            });
          }
