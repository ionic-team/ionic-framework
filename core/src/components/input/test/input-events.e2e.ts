  ...
  test.describe('when the input is blurred', () => {
    test.describe('should emit', () => {
      test('if the value has changed', async ({ page }) => {
        await page.setContent(`<ion-input label="input label"></ion-input>`);
    ...
    test.describe('should not emit', () => {
      test('if the value has not changed', async ({ page }) => {
        await page.setContent(`<ion-input label="input label" value="" clear-input="true"></ion-input>`);
...
test.describe('input: events: ionInput', () => {
  test('should emit when the input is cleared', async ({ page }) => {
    await page.setContent(`<ion-input label="input label" value="some value" clear-input="true"></ion-input>`);
  ...
  test('should emit when the input is cleared from the keyboard', async ({ page }) => {
    await page.setContent(`<ion-input label="input label" value="some value" clear-on-edit="true"></ion-input>`);
