      ...
      await page.setContent(
        ...
        <ion-tab-bar color="light" selected-tab="1">
          <ion-tab-button tab="1" layout="icon-start">
            ...
            <ion-badge color="danger" vertical="top" size="small" shape="round">12</ion-badge>
          </ion-tab-button>
      ...
      await page.setContent(
        ...
        <ion-tab-bar color="danger" selected-tab="1">
          ...
          <ion-tab-button tab="2" layout="icon-end">
            <ion-label>Favorites</ion-label>
            <ion-icon name="heart"></ion-icon>
            <ion-badge color="dark" vertical="top" size="small" shape="round">33</ion-badge>
          </ion-tab-button>
      ...
      await page.setContent(
        ...
        <ion-tab-bar color="primary" selected-tab="1">
          ...
          <ion-tab-button tab="3" layout="icon-hide">
            <ion-label>Settings</ion-label>
            <ion-icon name="settings"></ion-icon>
            <ion-badge color="danger" vertical="top" size="small" shape="round">2</ion-badge>
          </ion-tab-button>
        </ion-tab-bar>
      `,
        config
