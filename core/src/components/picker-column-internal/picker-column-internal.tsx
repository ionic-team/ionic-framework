  ...
  implements ComponentInterface
{
  ...
  componentWillLoad() {
    ...
    const parentEl = (this.parentEl =
      this.el.closest(
        'ion-picker-internal'
      ) as HTMLIonPickerInternalElement | null);
    if (parentEl !== null) {
      // TODO(FW-2832): type
  ...
  private inputModeChange = (
    ...
    const isColumnActive =
      inputModeColumn === undefined ||
      inputModeColumn === this.el;
    ...
    () => {
      ...
      const scrollCallback = () => {
        raf(() => {
          ...
          const activeElement =
            el.shadowRoot!.elementFromPoint(
              centerX,
              centerY
  ...
  get activeItem() {
    ...
    const selector = `.picker-item[data-value="${
      this.value
    }"]${
      this.disabled
        ? ''
...
const PICKER_ITEM_ACTIVE_CLASS =
  'picker-item-active';
const PICKER_ITEM_PART = 'wheel-item';
const PICKER_ITEM_ACTIVE_PART =
  'active';
