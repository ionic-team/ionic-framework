...
configs({
  ...
  ({ title, screenshot, config }) => {
    test.describe(
      title('select: wrapping'),
      () => {
        test('should not wrap text by default', async ({
          page,
        }) => {
      ...
      `,
          ...
          await expect(
            ...
            screenshot(`select-nowrap`)
          );
        });

        test('should wrap text with class', async ({
          page,
        }) => {
          await page.setContent(
            `
      ...
      `,
          ...
          await expect(
            ...
            screenshot(`select-wrap`)
          );
        });

        test('should not wrap label while wrapping text with class', async ({
          page,
        }) => {
          await page.setContent(
            `
