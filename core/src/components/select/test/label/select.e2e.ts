    ...
    test.describe(
      ...
      () => {
        test.describe(
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-start-justify-start`
                )
              );
            });
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-start-justify-end`
                )
              );
            });
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-start-justify-space-between`
                )
              );
            });
          }
        ...
        test.describe(
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-end-justify-start`
                )
              );
            });
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-end-justify-space-between`
                )
              );
            });
          }
        ...
        test.describe(
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-fixed-justify-start`
                )
              );
            });
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-fixed-justify-end`
                )
              );
            });
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-fixed-justify-space-between`
                )
              );
            });
          }
        ...
        test.describe(
          ...
          () => {
            test('label should appear above the select when there is a value', async ({
              page,
            }) => {
              await page.setContent(
                `
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-floating-value`
                )
              );
            });
            test('label should appear on top of the select when there is no value', async ({
              page,
            }) => {
              await page.setContent(
                `
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-floating-no-value`
                )
              );
            });
            test('label should appear on top of the select when there is a placeholder and no value', async ({
              page,
            }) => {
              await page.setContent(
                `
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-floating-no-value-placeholder`
                )
              );
            });
            test('label should appear on top of the select when the select is expanded', async ({
              page,
            }) => {
              await page.setContent(
                `
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-floating-expanded`
                )
              );
            });
            test('long text should truncate', async ({
              page,
            }) => {
              await page.setContent(
                `
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-floating-long-text`
                )
              );
            });
          }
        ...
        test.describe(
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-stacked-value`
                )
              );
            });
            test('label should appear above the select when there is no value', async ({
              page,
            }) => {
              await page.setContent(
                `
         ...
         `,
              ...
              await expect(
                ...
                screenshot(
                  `select-label-stacked-long-text`
                )
              );
            });
          }
...
configs({
  ...
  ({ title, screenshot, config }) => {
    test.describe(
      title('select: label overflow'),
      () => {
        test('label property should be truncated with ellipses', async ({
          page,
        }) => {
          await page.setContent(
            `
        ...
        test('label slot should be truncated with ellipses', async ({
          page,
        }) => {
          await page.setContent(
            `
...
configs({
  ...
  test.describe(
    title('select: alert label'),
    () => {
      test('should use the label prop to set the default header in an alert', async ({
        page,
      }) => {
        await page.setContent(
          `
       ...
       `,
        ...
        await expect(
          alert.locator('.alert-title')
        ).toHaveText('My Alert');
      });
      test('should use the label slot to set the default header in an alert', async ({
        page,
      }) => {
        await page.setContent(
          `
