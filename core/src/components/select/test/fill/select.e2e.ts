      ...
      () => {
        ...
        `,
              ...
              await expect(
                ...
                screenshot(
                  `select-fill-solid-label-floating`
                )
              );
            });
        ...
        `,
              ...
              await expect(
                ...
                screenshot(
                  `select-fill-shaped-solid-custom`
                )
              );
            });
          }
        ...
        `,
              ...
              await expect(
                ...
                screenshot(
                  `select-fill-outline-label-floating`
                )
              );
            });
  ...
  ({ title, screenshot, config }) => {
    test.describe(
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `select-fill-outline-slotted-label`
            )
          );
        });
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `select-fill-outline-hidden-slotted-label`
            )
          );
        });
      }
    ...
    test.describe(
      ...
      `,
          ...
          const notchCutout =
            page.locator(
              'ion-select .select-outline-notch'
            );
          await expect(
            notchCutout
          ).toBeHidden();
