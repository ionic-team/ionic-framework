...
configs().forEach(({ title, config }) => {
  test.describe('select: basic', () => {
    ...
    test(title('should not open multiple alert windows when clicked multiple times'), async ({ page }) => {
    ...
    test.describe('select: alert', () => {
      test(title('it should open an alert select'), async ({ page }) => {
    ...
    test.describe('select: action sheet', () => {
      test(title('it should open an action sheet select'), async ({ page }) => {
    ...
    test.describe('select: popover', () => {
      test(title('it should open a popover select'), async ({ page, browserName }) => {
