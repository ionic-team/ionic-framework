...
| ------------------ | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| `cancelText`       | `cancel-text`   | The text to display on the cancel button.                                                                                                                                                                                                                                                                                                                                         | `string`                                 |
| `disabled`         | `disabled`      | If `true`, the user cannot interact with the select.                                                                                                                                                                                                                                                                                                                              | `boolean`                                |
...
| `interface`        | `interface`     | The interface the select should use: `action-sheet`, `popover` or `alert`.                                                                                                                                                                                                                                                                                                        | `"action-sheet" \| "alert" \| "popover"` |
...
| `okText`           | `ok-text`       | The text to display on the ok button.                                                                                                                                                                                                                                                                                                                                             | `string`                                 |
