...
export class SegmentButton
  implements
    ...
    ButtonInterface
{
  private segmentEl: HTMLIonSegmentElement | null =
    null;
  private nativeEl:
    | HTMLButtonElement
    | undefined;
