  ...
  ({ config, screenshot, title }) => {
    test.describe(
      ...
      () => {
        ...
        test('should reflect aria-label', async ({
          page,
        }) => {
      ...
      `,
          ...
          const item2 = page.locator(
            '#item-2 .item-native'
          );

          expect(
            await item1.getAttribute(
              'aria-label'
            )
          ).toEqual('test');
          expect(
            await item2.getAttribute(
              'aria-label'
            )
          ).toEqual('test');
        });
    ...
    test.describe(
      ...
      `,
          ...
          await expect(
            ...
            screenshot(`item-scale`)
          );
        });
        test('should scale slotted icons on larger font sizes', async ({
          page,
        }) => {
          await page.setContent(
            `
      ...
      `,
        ...
        test('should scale detail icon on larger font sizes', async ({
          page,
        }) => {
          await page.setContent(
            `
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `item-detail-icon-scale`
            )
          );
        });
        test('should scale counter text on larger font sizes', async ({
          page,
        }) => {
          await page.setContent(
            `
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `item-counter-text-scale`
            )
          );
        });
        test('should scale helper and error text on larger font sizes', async ({
          page,
        }) => {
          await page.setContent(
            `
      ...
      `,
          ...
          await expect(
            ...
            screenshot(
              `item-helper-error-text-scale`
            )
          );
        });
        test('should scale buttons in an item on larger font sizes', async ({
          page,
        }) => {
          await page.setContent(
            `
