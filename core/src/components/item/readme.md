...
| `fill`            | `fill`             | The fill for the item. If `'solid'` the item will have a background. If `'outline'` the item will be transparent with a border.                                                                                                                                                           | `"outline" \| "solid" \| undefined`                     | `undefined`         |
