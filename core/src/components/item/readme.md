...
| `detail`          | `detail`           | If `true`, a detail arrow will appear on the item. Defaults to `false` unless the `mode` is `ios` and a `href` or `button` property is present.                                                                                                                        | `boolean \| undefined`                     | `undefined`           |
