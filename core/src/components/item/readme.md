...
| `counter`         | `counter`          | If `true`, a text based counter will display the input's length over its maxlength.                                                                                                                                                                                                       | `boolean \| undefined`                                  | `true`              |
...
| `fill`            | `fill`             | The fill for the item. If "solid" it will have a background, if "outline" it will be transparent with a border.                                                                                                                                                                           | `"outline" \| "solid" \| undefined`                     | `undefined`         |
