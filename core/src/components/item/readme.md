...
| Slot      | Description                                                                          |
| --------- | ------------------------------------------------------------------------------------ |
|           | The default slot should contain the item text.                                       |
| `"end"`   | Content will be placed to the right of the item text in LTR, and to the left in RTL. |
| `"start"` | Content will be placed to the left of the item text in LTR, and to the right in RTL. |
