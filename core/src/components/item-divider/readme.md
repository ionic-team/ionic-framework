...
| `"end"`   | Content will be placed on the right side within the divider in LTR, and to the left side in RTL. |
| `"start"` | Content will be placed on the left side within the divider in LTR, and on the right side in RTL. |
