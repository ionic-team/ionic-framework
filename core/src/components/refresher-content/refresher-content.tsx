  ...
  implements ComponentInterface
{
  ...
  private renderPullingText() {
    ...
    return (
      <div class="refresher-pulling-text">
        {pullingText}
      </div>
    );
  }
  ...
  private renderRefreshingText() {
    ...
    return (
      <div class="refresher-refreshing-text">
        {refreshingText}
      </div>
    );
  }
