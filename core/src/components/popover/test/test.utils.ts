...
export const screenshotPopover = async (page: E2EPage, config: E2EPageOptions, buttonID: string, testName: string) => {
  await page.goto(`src/components/popover/test/${testName}`, config);
