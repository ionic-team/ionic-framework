...
configs().forEach(
  ({ title, screenshot, config }) => {
    test.describe(
      title(
        'popover: nested rendering'
      ),
      async () => {
        test.beforeEach(
          async ({ page }) => {
            await page.goto(
              '/src/components/popover/test/nested',
              config
            );
          }
        );
        ...
        test('should render correctly', async ({
          ...
          await expect(
            ...
            screenshot(`popover-nested`)
          );
        });

        test('should render multiple levels of nesting correctly', async ({
          page,
        }) => {
          const ionPopoverDidPresent =
            await page.spyOnEvent(
...
configs({
  ...
  test.describe(
    ...
    () => {
      ...
      test('should dismiss when clicking backdrop', async ({
        page,
      }) => {
        const ionPopoverDidPresent =
          await page.spyOnEvent(
