      ...
      async () => {
        test('should not have visual regressions', async ({
          ...
          await popoverFixture.goto(
            `src/components/popover/test/basic`,
            config
          );
    ...
    test.describe(
      ...
      async () => {
        ...
        test('should render translucent header popover', async () => {
          ...
          await popoverFixture.screenshot(
            'basic-translucent-header-popover',
            screenshot
          );
        });
      }
...
configs({
  ...
  test.describe(
    ...
    async () => {
      ...
      test('should focus the first ion-item on ArrowDown', async ({
        page,
      }) => {
        const item0 = page.locator(
          'ion-popover ion-item:nth-of-type(1)'
        );
      ...
      test('should not override keyboard interactions for textarea elements', async ({
        page,
        browserName,
      }) => {
        const tabKey =
        ...
        const innerNativeTextarea = page
          .locator(
