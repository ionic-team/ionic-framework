...
| `cancelBrowserKeyboardEvents` | `cancel-browser-keyboard-events` | If `true`, the popover will cancel browser keyboard event bindings to prevent scroll behavior in a popover using a list of items.  Disable this behavior to allow the contents of the popover to handle their own keyboard interactions (i.e. when using CSS scroll snap).                                                                                                                                                                                                                                                   | `boolean`                                                    | `true`      |
