...
| `autocomplete`     | `autocomplete`       | Set the input's autocomplete property. Default `"off"`.                                                                                                                                                                                                                | `"on"`, `"off"` |
| `autocorrect`      | `autocorrect`        | Set the input's autocorrect property. Default `"off"`.                                                                                                                                                                                                                 | `"on"`, `"off"` |
