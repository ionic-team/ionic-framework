...
| `size`                 | `size`                    | If `cover`, the width of the `ion-datetime` component will be set to `100%`. If unset or `fixed`, the width of the component will be set to `350px`.                                                                                                                                                                                                                                                                                                                                              | `"cover" \| "fixed"`                             | `'fixed'`      |
