...
| ----------- | --------------------------------------------------- | ------------------- |
| `ionBlur`   | Emitted when the datetime loses focus.              | `CustomEvent<TODO>` |
| `ionCancel` | Emitted when the datetime selection was cancelled.  | `CustomEvent<TODO>` |
| `ionChange` | Emitted when the value (selected date) has changed. | `CustomEvent<TODO>` |
| `ionFocus`  | Emitted when the datetime has focus.                | `CustomEvent<TODO>` |
