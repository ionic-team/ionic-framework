...
| `timeFormat`           | `time-format`             | The time format of the `ion-datetime`. If no value is set, this is specified by the current locale.                                                                                                                                                                                                                                                                                                                                                                                               | `"12h" \| "24h" \| null \| undefined`            | `undefined`    |
