...
| `display`              | `display`                 | If `numpad`, the ìon-datetime` will show a numpad instead of a picker wheel. If `picker`, the ìon-datetime` will show a picker wheel.                                                                                                                                                                                                                                                                                                                                                             | `"numpad" \| "picker"`                                                                | `'picker'`     |
