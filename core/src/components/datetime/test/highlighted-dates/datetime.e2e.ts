  ...
  ({ title, screenshot, config }) => {
    test.describe(
      ...
      `,
        ...
        test('should render highlights correctly when using an array', async ({
          page,
        }) => {
          ...
          await expect(
            ...
            screenshot(
              `datetime-highlightedDates-array`
            )
          );
        });

        test('should render highlights correctly when using a callback', async ({
          page,
        }) => {
          const datetime = page.locator(
            'ion-datetime'
        ...
        test('should render highlights correctly when only using one color or the other', async ({
          page,
        }) => {
          const datetime = page.locator(
            'ion-datetime'
          ...
          await expect(
            ...
            screenshot(
              `datetime-highlightedDates-single-color`
            )
          );
        });
      }
