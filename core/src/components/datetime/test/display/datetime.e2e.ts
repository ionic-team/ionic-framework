  ...
  test.describe('datetime: display', () => {
    test.describe('datetime: rendering', () => {
      test.describe('fixed sizes', () => {
        test(title('date-time should not have any visual regressions'), async ({ page }) => {
        ...
        test(title('time-date should not have any visual regressions'), async ({ page }) => {
          await page.setContent(
            `
        ...
        test(title('time should not have any visual regressions'), async ({ page }) => {
          await page.setContent(
            `
        ...
        test(title('date should not have any visual regressions'), async ({ page }) => {
          await page.setContent(
            `
    ...
    test.describe('datetime: switch presentations', () => {
      test(title('month selection should work after changing presentation'), async ({ page }) => {
