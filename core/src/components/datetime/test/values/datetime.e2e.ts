...
configs({
  ...
  test.describe(
    ...
    () => {
      test('should render correct days', async ({
        page,
      }) => {
      ...
      test('should render correct months', async ({
        page,
      }) => {
        await page.setContent(
          `
      ...
      test('should render correct years', async ({
        page,
      }) => {
        await page.setContent(
          `
      ...
      test('should render correct hours', async ({
        page,
      }) => {
        await page.setContent(
          `
      ...
      `,
        ...
        const items = page.locator(
          'ion-picker-column-internal:first-of-type .picker-item:not(.picker-item-empty)'
        );
        await expect(items).toHaveText([
          '1',
          '2',
      ...
      test('should render correct minutes', async ({
        page,
      }) => {
        await page.setContent(
          `
      ...
      test('should adjust default parts for allowed hour and minute values', async ({
        page,
      }) => {
        /**
      ...
      `,
        ...
        const hourItems = page.locator(
          'ion-picker-column-internal:nth-of-type(1) .picker-item:not(.picker-item-empty)'
        );
        await expect(
          hourItems
        ).toHaveText(['2']);
         ...
         */
        const ampmItems = page.locator(
          'ion-picker-column-internal:nth-of-type(3) .picker-item:not(.picker-item-empty)'
        );
        await expect(
          ampmItems
        ).toHaveText(['AM', 'PM']);
      ...
      test('should adjust default parts month for allowed month values', async ({
        page,
      }) => {
        /**
         * Mock today's date for testing.
      ...
      test('today date highlight should persist even if disallowed from dayValues', async ({
        page,
      }) => {
        /**
         * Mock today's date for testing.
      ...
      `,
        ...
        const todayButton =
          page.locator(
            '.calendar-day[data-day="10"][data-month="10"][data-year="2022"]'
          );
