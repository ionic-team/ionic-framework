...
configs({
  ...
  test.describe(
    title('datetime: a11y'),
    () => {
      test('datetime should be keyboard navigable', async ({
        page,
        browserName,
      }) => {
        await page.setContent(
    ...
    `,
      ...
      test('buttons should be keyboard navigable', async ({
        page,
      }) => {
        await page.setContent(
          `
    ...
    `,
      ...
      test('should navigate through months via right arrow key', async ({
        page,
      }) => {
        await page.setContent(
          `
