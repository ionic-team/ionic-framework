...
`,
  ...
  private renderCalendarHeader(mode: Mode) {
    ...
    const monthYearText = getMonthAndYear(this.locale, this.workingParts);
    const toggleAriaLabel = showMonthAndYear
      ? `Hide year picker - ${monthYearText}`
      : `Show year picker - ${monthYearText}`;
      ...
      <div class="calendar-header">
        <div class="calendar-action-buttons">
          <div class="calendar-month-year">
            <button
              class="calendar-month-year-toggle ion-focusable ion-activatable"
              aria-label={toggleAriaLabel}
              onClick={() => this.toggleMonthAndYearView()}
            >
              <ion-label>{monthYearText}</ion-label>
              <ion-icon
                aria-hidden="true"
