    ...
    test.describe(
      ...
      () => {
        test.beforeEach(
          async ({ page }) => {
            await page.goto(
              '/src/components/alert/test/basic',
              config
            );
          }
        );
        test('focus trap should work correctly', async ({
          page,
          browserName,
        }) => {
          const tabKey =
          ...
          const alert =
            await alertFixture.open(
              '#multipleButtons'
            );
          const alertBtns =
            alert.locator('button');
        ...
        test('should set custom attributes', async ({
          page,
        }) => {
          const alertFixture =
            new AlertFixture(
        ...
        test('should dismiss when async handler resolves', async ({
          page,
        }) => {
...
configs().forEach(
  ({ config, screenshot, title }) => {
    test.describe(
      title(
        'should not have visual regressions'
      ),
      () => {
