...
export interface LocalIntrinsicElements {
  'ion-action-sheet-controller': StencilComponents.IonActionSheetControllerAttributes;
  'ion-action-sheet': StencilComponents.IonActionSheetAttributes;
  'ion-alert-controller': StencilComponents.IonAlertControllerAttributes;
  'ion-alert': StencilComponents.IonAlertAttributes;
  'ion-anchor': StencilComponents.IonAnchorAttributes;
  'ion-animation-controller': StencilComponents.IonAnimationControllerAttributes;
  'ion-app': StencilComponents.IonAppAttributes;
  'ion-avatar': StencilComponents.IonAvatarAttributes;
  'ion-back-button': StencilComponents.IonBackButtonAttributes;
  'ion-backdrop': StencilComponents.IonBackdropAttributes;
  'ion-badge': StencilComponents.IonBadgeAttributes;
  'ion-button': StencilComponents.IonButtonAttributes;
  'ion-buttons': StencilComponents.IonButtonsAttributes;
  'ion-card-content': StencilComponents.IonCardContentAttributes;
  'ion-card-header': StencilComponents.IonCardHeaderAttributes;
  'ion-card-subtitle': StencilComponents.IonCardSubtitleAttributes;
  'ion-card-title': StencilComponents.IonCardTitleAttributes;
  'ion-card': StencilComponents.IonCardAttributes;
  'ion-checkbox': StencilComponents.IonCheckboxAttributes;
  'ion-chip-button': StencilComponents.IonChipButtonAttributes;
  'ion-chip-icon': StencilComponents.IonChipIconAttributes;
  'ion-chip': StencilComponents.IonChipAttributes;
  'ion-col': StencilComponents.IonColAttributes;
  'ion-content': StencilComponents.IonContentAttributes;
  'ion-datetime': StencilComponents.IonDatetimeAttributes;
  'ion-fab-button': StencilComponents.IonFabButtonAttributes;
  'ion-fab-list': StencilComponents.IonFabListAttributes;
  'ion-fab': StencilComponents.IonFabAttributes;
  'ion-footer': StencilComponents.IonFooterAttributes;
  'ion-grid': StencilComponents.IonGridAttributes;
  'ion-header': StencilComponents.IonHeaderAttributes;
  'ion-hide-when': StencilComponents.IonHideWhenAttributes;
  'ion-img': StencilComponents.IonImgAttributes;
  'ion-infinite-scroll-content': StencilComponents.IonInfiniteScrollContentAttributes;
  'ion-infinite-scroll': StencilComponents.IonInfiniteScrollAttributes;
  'ion-input': StencilComponents.IonInputAttributes;
  'ion-item-divider': StencilComponents.IonItemDividerAttributes;
  'ion-item-group': StencilComponents.IonItemGroupAttributes;
  'ion-item-option': StencilComponents.IonItemOptionAttributes;
  'ion-item-options': StencilComponents.IonItemOptionsAttributes;
  'ion-item-sliding': StencilComponents.IonItemSlidingAttributes;
  'ion-item': StencilComponents.IonItemAttributes;
  'ion-label': StencilComponents.IonLabelAttributes;
  'ion-list-header': StencilComponents.IonListHeaderAttributes;
  'ion-list': StencilComponents.IonListAttributes;
  'ion-loading-controller': StencilComponents.IonLoadingControllerAttributes;
  'ion-loading': StencilComponents.IonLoadingAttributes;
  'ion-menu-button': StencilComponents.IonMenuButtonAttributes;
  'ion-menu-controller': StencilComponents.IonMenuControllerAttributes;
  'ion-menu-toggle': StencilComponents.IonMenuToggleAttributes;
  'ion-menu': StencilComponents.IonMenuAttributes;
  'ion-modal-controller': StencilComponents.IonModalControllerAttributes;
  'ion-modal': StencilComponents.IonModalAttributes;
  'ion-nav-pop': StencilComponents.IonNavPopAttributes;
  'ion-nav-push': StencilComponents.IonNavPushAttributes;
  'ion-nav-set-root': StencilComponents.IonNavSetRootAttributes;
  'ion-nav': StencilComponents.IonNavAttributes;
  'ion-note': StencilComponents.IonNoteAttributes;
  'ion-picker-column': StencilComponents.IonPickerColumnAttributes;
  'ion-picker-controller': StencilComponents.IonPickerControllerAttributes;
  'ion-picker': StencilComponents.IonPickerAttributes;
  'ion-popover-controller': StencilComponents.IonPopoverControllerAttributes;
  'ion-popover': StencilComponents.IonPopoverAttributes;
  'ion-radio-group': StencilComponents.IonRadioGroupAttributes;
  'ion-radio': StencilComponents.IonRadioAttributes;
  'ion-range': StencilComponents.IonRangeAttributes;
  'ion-refresher-content': StencilComponents.IonRefresherContentAttributes;
  'ion-refresher': StencilComponents.IonRefresherAttributes;
  'ion-reorder-group': StencilComponents.IonReorderGroupAttributes;
  'ion-reorder': StencilComponents.IonReorderAttributes;
  'ion-ripple-effect': StencilComponents.IonRippleEffectAttributes;
  'ion-route-redirect': StencilComponents.IonRouteRedirectAttributes;
  'ion-route': StencilComponents.IonRouteAttributes;
  'ion-router-outlet': StencilComponents.IonRouterOutletAttributes;
  'ion-router': StencilComponents.IonRouterAttributes;
  'ion-row': StencilComponents.IonRowAttributes;
  'ion-searchbar': StencilComponents.IonSearchbarAttributes;
  'ion-segment-button': StencilComponents.IonSegmentButtonAttributes;
  'ion-segment': StencilComponents.IonSegmentAttributes;
  'ion-select-option': StencilComponents.IonSelectOptionAttributes;
  'ion-select-popover': StencilComponents.IonSelectPopoverAttributes;
  'ion-select': StencilComponents.IonSelectAttributes;
  'ion-show-when': StencilComponents.IonShowWhenAttributes;
  'ion-skeleton-text': StencilComponents.IonSkeletonTextAttributes;
  'ion-slide': StencilComponents.IonSlideAttributes;
  'ion-slides': StencilComponents.IonSlidesAttributes;
  'ion-spinner': StencilComponents.IonSpinnerAttributes;
  'ion-split-pane': StencilComponents.IonSplitPaneAttributes;
  ...
  'ion-title': StencilComponents.IonTitleAttributes;
  'ion-toast-controller': StencilComponents.IonToastControllerAttributes;
  'ion-toast': StencilComponents.IonToastAttributes;
  'ion-toggle': StencilComponents.IonToggleAttributes;
  'ion-toolbar': StencilComponents.IonToolbarAttributes;
  'ion-virtual-scroll': StencilComponents.IonVirtualScrollAttributes;
}
