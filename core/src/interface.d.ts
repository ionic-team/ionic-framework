...
import type {
  Components as IoniconsComponents,
  JSX as IoniconsJSX,
} from 'ionicons';
...
export {
  ...
  ScrollCallback,
  ScrollCustomEvent,
} from './components/content/content-interface';
export { CheckboxCustomEvent } from './components/checkbox/checkbox-interface';
export {
  DatetimeCustomEvent,
  DatetimeHighlightStyle,
} from './components/datetime/datetime-interface';
...
} from './utils/hardware-back-button';
...
export type ComponentRef =
  ...
  | null;
// eslint-disable-next-line
export type ComponentProps<T = null> = {
  [key: string]: any;
};
