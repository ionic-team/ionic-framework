...
36. Add a `global.scss` file alongside your `theme/variables.scss` file to house your site-wide styles.  You can use [ionic2-app-base](https://github.com/driftyco/ionic2-app-base/blob/master/src/theme/global.scss) as a reference.  
