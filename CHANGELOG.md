...
* **item:**
  * fix padding for items ([56bb89e1](https://github.com/driftyco/ionic/commit/56bb89e1), closes [#5534](https://github.com/driftyco/ionic/issues/5534))
...
* **modal:**
  * Don't show click-block-div unnecessarily on remove() ([b0c89ef7](https://github.com/driftyco/ionic/commit/b0c89ef7))
...
* **scroll:**
  * remove overflow scroll hidden for iOS ([aec6598d](https://github.com/driftyco/ionic/commit/aec6598d))
...
* **scrolling:**
  * removing faulty logic that executes on propagated scroll events ([7c6fc926](https://github.com/driftyco/ionic/commit/7c6fc926))
...
* **slides:**
  * resolves data-update issue on duplicate slides #5739 ([db8304d2](https://github.com/driftyco/ionic/commit/db8304d2))
...
* **tab:** tabs are now styled directly via dom manipulations ([fbae1aba](https://github.com/driftyco/ionic/commit/fbae1aba))
* **tabs:**
  * tabs-color-active works with tabs-striped ([237d79b7](https://github.com/driftyco/ionic/commit/237d79b7))
  * overflow scroll with child not view. ([1f2178f3](https://github.com/driftyco/ionic/commit/1f2178f3), closes [#4891](https://github.com/driftyco/ionic/issues/4891))
...
* **angular:**
  * Upgrade to Angular 1.5 ([234a8964](https://github.com/driftyco/ionic/commit/234a8964))
...
* **fonts:**
  * iOS 9 fonts now for safari ([760b70d1](https://github.com/driftyco/ionic/commit/760b70d1))
  * platform specific fonts ([dfcbef1a](https://github.com/driftyco/ionic/commit/dfcbef1a))
