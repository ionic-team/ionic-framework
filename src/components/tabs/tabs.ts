import { AfterViewInit, Component, ElementRef, EventEmitter, forwardRef, Input, Output, Optional, Renderer2, ViewChild, ViewContainerRef, ViewEncapsulation } from '@angular/core';
