...
import { mockConfig, MockDomController, mockRenderer, mockElementRef, mockHaptic } from '../../../util/mock-providers';
...
function createRange(): Range {
  let form = new Form();
  return new Range(form, mockHaptic(), null, mockConfig(), mockElementRef(), mockRenderer(), new MockDomController());
}
