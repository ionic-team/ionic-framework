...
import { App, provideDeepLinker } from '../../../../../src';
import { DeepLink, NavParams, ViewController } from '../../../../../src';;
  ...
  template: `
    ...
    <ion-content>
      <ion-list>
        ...
        <a ion-item navPush="FirstPage" [navParams]="{id: 23}">Push w/ a[navPush] with "FirstPage" string and [navParams]</a>
        <button ion-item navPush="first-page" [navParams]="{id: 23}">Push w/ button[navPush] with "first-page" string and [navParams]</button>
...
class FirstPage {
  ...
  pushFullPage() {
    this.nav.push(FullPage, { id: 8675309, myData: [1, 2, 3, 4], h: '你好' });
  }
...
let deepLinkConfig: DeepLink[] = [
  { component: FirstPage, name: 'first-page', path: 'first-name' },
  { component: FullPage, name:'full-view', path: 'full-view/:id' },
  { component: PrimaryHeaderPage, name: 'primary-header' },
  { component: AnotherPage, name: 'another-page' }
];

ionicBootstrap(E2EApp, [provideDeepLinker(deepLinkConfig)]).then((componetRef) => {
