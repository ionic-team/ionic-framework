...
export class MenuContentGesture extends SlideEdgeGesture {
  ...
  onSlideEnd(slide: SlideData, ev: any) {
    let z = ((this.menu.isRightSide && !this.plt.isRTL) || (!this.menu.isRightSide && this.plt.isRTL) ? slide.min : slide.max);
  ...
  getElementStartPos(slide: SlideData, ev: any) {
    const menu = this.menu;
    if ((menu.isRightSide && !this.plt.isRTL) || (!menu.isRightSide && this.plt.isRTL)) {
