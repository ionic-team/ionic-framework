...
export class IonicModule {
     ...
     * @param appRoot The root AppComponent for this app.
     * @param config Config Options for the app. Accepts any config property.
     * @param deepLinkConfig Any configuration needed for the Ionic Deeplinker.
     */
