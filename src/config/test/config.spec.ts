...
describe('Config', () => {
  ...
  fit('should set activator setting to ripple for Android v5.0 and above using Chrome v36 and above on a linux device', () => {
  ...
  fit('should set activator setting to none for Android v4.4 and below and Chrome v36 and above on a linux device', () => {
