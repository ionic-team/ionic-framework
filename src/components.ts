...
export { DeepLinker, provideDeepLinker } from './components/nav/nav-deep-linker';
...
export { NavLink, NavLinkConfig, NavPath, NavOptions, DeepLink } from './components/nav/nav-util';
