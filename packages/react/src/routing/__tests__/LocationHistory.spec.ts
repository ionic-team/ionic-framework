  ...
  describe("Replacing history", () => {
    describe("tab1 > tab1/details/1, tab1/details/2, Replace to tab1/details/3", () => {
      beforeEach(() => {
        ...
        const details2Route = createRoute(
          "/tab1/details/2",
          details1Route,
          "tab1"
        );
        const details3Route = createRoute(
          "/tab1/details/3",
          details2Route,
          "tab1",
          "replace"
      ...
      it("tab1 history should have 3 entries and they should have correct paths", () => {
        ...
        expect((locationHistory as any).tabHistory["tab1"][0].pathname).toEqual(
          "/tab1"
        );
        expect((locationHistory as any).tabHistory["tab1"][1].pathname).toEqual(
          "/tab1/details/1"
        );
        expect((locationHistory as any).tabHistory["tab1"][2].pathname).toEqual(
          "/tab1/details/3"
        );
      });
      ...
      it("locationHistory should have 3 entries and they should have correct paths", () => {
        expect((locationHistory as any).locationHistory.length).toEqual(3);
        expect((locationHistory as any).locationHistory[0].pathname).toEqual(
          "/tab1"
        );
        expect((locationHistory as any).locationHistory[1].pathname).toEqual(
          "/tab1/details/1"
        );
        expect((locationHistory as any).locationHistory[2].pathname).toEqual(
          "/tab1/details/3"
        );
      });
    });
