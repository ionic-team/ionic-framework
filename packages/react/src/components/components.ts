...
import { IonDivider as IonDividerElement, defineCustomElement as defineIonDivider } from "@ionic/core/components/ion-divider.js";
...
import { IonGalleryItem as IonGalleryItemElement, defineCustomElement as defineIonGalleryItem } from "@ionic/core/components/ion-gallery-item.js";
import { IonGallery as IonGalleryElement, defineCustomElement as defineIonGallery } from "@ionic/core/components/ion-gallery.js";
...
export type IonDividerEvents = NonNullable<unknown>;

export const IonDivider: StencilReactComponent<IonDividerElement, IonDividerEvents, Components.IonDivider> = /*@__PURE__*/ createComponent<IonDividerElement, IonDividerEvents, Components.IonDivider>({
    tagName: 'ion-divider',
    elementClass: IonDividerElement,
    // @ts-ignore - ignore potential React type mismatches between the Stencil Output Target and your project.
    react: React,
    events: {} as IonDividerEvents,
    defineCustomElement: defineIonDivider
});
...
export type IonGalleryEvents = NonNullable<unknown>;

export const IonGallery: StencilReactComponent<IonGalleryElement, IonGalleryEvents, Components.IonGallery> = /*@__PURE__*/ createComponent<IonGalleryElement, IonGalleryEvents, Components.IonGallery>({
    tagName: 'ion-gallery',
    elementClass: IonGalleryElement,
    // @ts-ignore - ignore potential React type mismatches between the Stencil Output Target and your project.
    react: React,
    events: {} as IonGalleryEvents,
    defineCustomElement: defineIonGallery
});

export type IonGalleryItemEvents = NonNullable<unknown>;

export const IonGalleryItem: StencilReactComponent<IonGalleryItemElement, IonGalleryItemEvents, Components.IonGalleryItem> = /*@__PURE__*/ createComponent<IonGalleryItemElement, IonGalleryItemEvents, Components.IonGalleryItem>({
    tagName: 'ion-gallery-item',
    elementClass: IonGalleryItemElement,
    // @ts-ignore - ignore potential React type mismatches between the Stencil Output Target and your project.
    react: React,
    events: {} as IonGalleryItemEvents,
    defineCustomElement: defineIonGalleryItem
});
