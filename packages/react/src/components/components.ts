...
export const IonAccordion = createComponent<IonAccordionElement, IonAccordionEvents>({
...
type IonAccordionGroupEvents = { onIonChange: EventName<IonAccordionGroupCustomEvent<AccordionGroupChangeEventDetail<any>>> };

export const IonAccordionGroup = createComponent<IonAccordionGroupElement, IonAccordionGroupEvents>({
...
export const IonAvatar = createComponent<IonAvatarElement, IonAvatarEvents>({
  tagName: 'ion-avatar',
...
export const IonBackdrop = createComponent<IonBackdropElement, IonBackdropEvents>({
...
export const IonBadge = createComponent<IonBadgeElement, IonBadgeEvents>({
  tagName: 'ion-badge',
...
export const IonBreadcrumbs = createComponent<IonBreadcrumbsElement, IonBreadcrumbsEvents>({
...
export const IonButtons = createComponent<IonButtonsElement, IonButtonsEvents>({
  tagName: 'ion-buttons',
...
export const IonCardContent = createComponent<IonCardContentElement, IonCardContentEvents>({
...
export const IonCardHeader = createComponent<IonCardHeaderElement, IonCardHeaderEvents>({
...
export const IonCardSubtitle = createComponent<IonCardSubtitleElement, IonCardSubtitleEvents>({
...
export const IonCardTitle = createComponent<IonCardTitleElement, IonCardTitleEvents>({
...
type IonCheckboxEvents = {
  onIonChange: EventName<IonCheckboxCustomEvent<CheckboxChangeEventDetail<any>>>,
  onIonFocus: EventName<CustomEvent<void>>,
  onIonBlur: EventName<CustomEvent<void>>
};

export const IonCheckbox = createComponent<IonCheckboxElement, IonCheckboxEvents>({
...
export const IonChip = createComponent<IonChipElement, IonChipEvents>({
  tagName: 'ion-chip',
...
export const IonCol = createComponent<IonColElement, IonColEvents>({
  tagName: 'ion-col',
...
export const IonContent = createComponent<IonContentElement, IonContentEvents>({
  tagName: 'ion-content',
...
export const IonDatetime = createComponent<IonDatetimeElement, IonDatetimeEvents>({
...
export const IonDatetimeButton = createComponent<IonDatetimeButtonElement, IonDatetimeButtonEvents>({
...
export const IonFab = createComponent<IonFabElement, IonFabEvents>({
  tagName: 'ion-fab',
...
export const IonFabList = createComponent<IonFabListElement, IonFabListEvents>({
...
export const IonFooter = createComponent<IonFooterElement, IonFooterEvents>({
  tagName: 'ion-footer',
...
export const IonGrid = createComponent<IonGridElement, IonGridEvents>({
  tagName: 'ion-grid',
...
export const IonHeader = createComponent<IonHeaderElement, IonHeaderEvents>({
  tagName: 'ion-header',
...
export const IonImg = createComponent<IonImgElement, IonImgEvents>({
  tagName: 'ion-img',
...
export const IonInfiniteScroll = createComponent<IonInfiniteScrollElement, IonInfiniteScrollEvents>({
...
export const IonInfiniteScrollContent = createComponent<IonInfiniteScrollContentElement, IonInfiniteScrollContentEvents>({
...
export const IonInput = createComponent<IonInputElement, IonInputEvents>({
  tagName: 'ion-input',
...
export const IonInputPasswordToggle = createComponent<IonInputPasswordToggleElement, IonInputPasswordToggleEvents>({
...
export const IonItemDivider = createComponent<IonItemDividerElement, IonItemDividerEvents>({
...
export const IonItemGroup = createComponent<IonItemGroupElement, IonItemGroupEvents>({
...
export const IonItemOptions = createComponent<IonItemOptionsElement, IonItemOptionsEvents>({
...
export const IonItemSliding = createComponent<IonItemSlidingElement, IonItemSlidingEvents>({
...
export const IonLabel = createComponent<IonLabelElement, IonLabelEvents>({
  tagName: 'ion-label',
...
export const IonList = createComponent<IonListElement, IonListEvents>({
  tagName: 'ion-list',
...
export const IonListHeader = createComponent<IonListHeaderElement, IonListHeaderEvents>({
...
export const IonMenu = createComponent<IonMenuElement, IonMenuEvents>({
  tagName: 'ion-menu',
...
export const IonMenuButton = createComponent<IonMenuButtonElement, IonMenuButtonEvents>({
...
export const IonMenuToggle = createComponent<IonMenuToggleElement, IonMenuToggleEvents>({
...
export const IonNav = createComponent<IonNavElement, IonNavEvents>({
  tagName: 'ion-nav',
...
export const IonNavLink = createComponent<IonNavLinkElement, IonNavLinkEvents>({
...
export const IonNote = createComponent<IonNoteElement, IonNoteEvents>({
  tagName: 'ion-note',
...
export const IonPicker = createComponent<IonPickerElement, IonPickerEvents>({
  tagName: 'ion-picker',
...
export const IonPickerColumn = createComponent<IonPickerColumnElement, IonPickerColumnEvents>({
...
export const IonPickerColumnOption = createComponent<IonPickerColumnOptionElement, IonPickerColumnOptionEvents>({
...
export const IonProgressBar = createComponent<IonProgressBarElement, IonProgressBarEvents>({
...
export const IonRadio = createComponent<IonRadioElement, IonRadioEvents>({
  tagName: 'ion-radio',
...
type IonRadioGroupEvents = { onIonChange: EventName<IonRadioGroupCustomEvent<RadioGroupChangeEventDetail<any>>> };

export const IonRadioGroup = createComponent<IonRadioGroupElement, IonRadioGroupEvents>({
...
export const IonRange = createComponent<IonRangeElement, IonRangeEvents>({
  tagName: 'ion-range',
...
export const IonRefresher = createComponent<IonRefresherElement, IonRefresherEvents>({
...
export const IonRefresherContent = createComponent<IonRefresherContentElement, IonRefresherContentEvents>({
...
export const IonReorder = createComponent<IonReorderElement, IonReorderEvents>({
  tagName: 'ion-reorder',
...
export const IonReorderGroup = createComponent<IonReorderGroupElement, IonReorderGroupEvents>({
...
export const IonRippleEffect = createComponent<IonRippleEffectElement, IonRippleEffectEvents>({
...
export const IonRow = createComponent<IonRowElement, IonRowEvents>({
  tagName: 'ion-row',
...
export const IonSearchbar = createComponent<IonSearchbarElement, IonSearchbarEvents>({
...
export const IonSegment = createComponent<IonSegmentElement, IonSegmentEvents>({
  tagName: 'ion-segment',
...
export const IonSegmentButton = createComponent<IonSegmentButtonElement, IonSegmentButtonEvents>({
...
type IonSelectEvents = {
  onIonChange: EventName<IonSelectCustomEvent<SelectChangeEventDetail<any>>>,
  onIonCancel: EventName<CustomEvent<void>>,
...
export const IonSelect = createComponent<IonSelectElement, IonSelectEvents>({
  tagName: 'ion-select',
...
export const IonSelectOption = createComponent<IonSelectOptionElement, IonSelectOptionEvents>({
...
export const IonSkeletonText = createComponent<IonSkeletonTextElement, IonSkeletonTextEvents>({
...
export const IonSpinner = createComponent<IonSpinnerElement, IonSpinnerEvents>({
  tagName: 'ion-spinner',
...
export const IonSplitPane = createComponent<IonSplitPaneElement, IonSplitPaneEvents>({
...
export const IonTab = createComponent<IonTabElement, IonTabEvents>({
  tagName: 'ion-tab',
...
export const IonText = createComponent<IonTextElement, IonTextEvents>({
  tagName: 'ion-text',
...
export const IonTextarea = createComponent<IonTextareaElement, IonTextareaEvents>({
...
export const IonThumbnail = createComponent<IonThumbnailElement, IonThumbnailEvents>({
...
export const IonTitle = createComponent<IonTitleElement, IonTitleEvents>({
  tagName: 'ion-title',
...
type IonToggleEvents = {
  onIonChange: EventName<IonToggleCustomEvent<ToggleChangeEventDetail<any>>>,
  onIonFocus: EventName<CustomEvent<void>>,
  onIonBlur: EventName<CustomEvent<void>>
};

export const IonToggle = createComponent<IonToggleElement, IonToggleEvents>({
  tagName: 'ion-toggle',
...
export const IonToolbar = createComponent<IonToolbarElement, IonToolbarEvents>({
  tagName: 'ion-toolbar',
