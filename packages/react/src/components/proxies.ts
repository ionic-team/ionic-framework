...
export interface HrefProps {
  /**
   * When using a router, it specifies if the transition takes place when navigating to another page using `href`. Defaults to false.
   */
...
export const IonRouterLink = /*@__PURE__*/createReactComponent<JSX.IonRouterLink & HrefProps, HTMLIonRouterLinkElement>('ion-router-link', true);
...
export const IonButton = /*@__PURE__*/createReactComponent<JSX.IonButton & HrefProps, HTMLIonButtonElement & HrefProps>('ion-button', true);
export const IonButtons = /*@__PURE__*/createReactComponent<JSX.IonButtons, HTMLIonButtonsElement>('ion-buttons');
export const IonCard = /*@__PURE__*/createReactComponent<JSX.IonCard & HrefProps, HTMLIonCardElement>('ion-card', true);
...
export const IonFabButton = /*@__PURE__*/createReactComponent<JSX.IonFabButton & HrefProps, HTMLIonFabButtonElement>('ion-fab-button', true);
...
export const IonItem = /*@__PURE__*/createReactComponent<JSX.IonItem & HrefProps, HTMLIonItemElement>('ion-item', true);
...
export const IonItemOption = /*@__PURE__*/createReactComponent<JSX.IonItemOption & HrefProps, HTMLIonItemOptionElement>('ion-item-option', true);
