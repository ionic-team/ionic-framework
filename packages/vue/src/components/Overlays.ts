...
export const IonActionSheet =
  /*@__PURE__*/ defineOverlayContainer<JSX.IonActionSheet>(
    "ion-action-sheet",
...
export const IonAlert = /*@__PURE__*/ defineOverlayContainer<JSX.IonAlert>(
  "ion-alert",
...
export const IonLoading = /*@__PURE__*/ defineOverlayContainer<JSX.IonLoading>(
  "ion-loading",
...
export const IonPicker = /*@__PURE__*/ defineOverlayContainer<JSX.IonPicker>(
  "ion-picker",
...
export const IonToast = /*@__PURE__*/ defineOverlayContainer<JSX.IonToast>(
  "ion-toast",
...
export const IonModal = /*@__PURE__*/ defineOverlayContainer<JSX.IonModal>(
  "ion-modal",
...
export const IonPopover = /*@__PURE__*/ defineOverlayContainer<JSX.IonPopover>(
  "ion-popover",
