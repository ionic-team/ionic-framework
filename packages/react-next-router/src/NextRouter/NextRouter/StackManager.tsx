...
import { DefaultIonLifeCycleContext, RouteInfo, RouteManagerContext, ViewLifeCycleManager } from '@ionic/react';
...
class StackManager extends React.Component<StackManagerProps, StackManagerState> {
  ...
  componentDidMount() {
    if (this.routerOutlet) {
      ...
      this.setupFirstPage(this.props.routeInfo!);
    }
  }
  ...
  registerIonPage(page: HTMLElement) {
    const pageId = this.props.routeInfo!.currentRoute;
  ...
  render() {
    ...
    if (ionRouterOutlet.props.ionPageContainer) {
      if (!this.pages.has(this.props.routeInfo.currentRoute)) {
        this.pages.set(this.props.routeInfo.currentRoute, {
          id: this.props.routeInfo.currentRoute,
