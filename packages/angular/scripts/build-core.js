...
function copySchematicsJson(){
  const src = path.join(__dirname, '..', 'lazy', 'src', 'schematics', 'collection.json');
  const fileSrc = path.join(__dirname, '..', 'lazy', 'src', 'schematics', 'add', 'files');
  const dst = path.join(__dirname, '..', 'dist', 'schematics', 'collection.json');
  const fileDst = path.join(__dirname, '..', 'dist', 'schematics', 'add', 'files');
  const schemaSrc = path.join(__dirname, '..', 'lazy', 'src', 'schematics', 'add', 'schema.json');
