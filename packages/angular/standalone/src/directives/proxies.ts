...
export class IonPickerLegacy {
  ...
  @Output() ionPickerDidPresent = new EventEmitter<IonPickerLegacyCustomEvent<void>>();
  @Output() ionPickerWillPresent = new EventEmitter<IonPickerLegacyCustomEvent<void>>();
  @Output() ionPickerWillDismiss = new EventEmitter<IonPickerLegacyCustomEvent<IIonPickerLegacyOverlayEventDetail>>();
  @Output() ionPickerDidDismiss = new EventEmitter<IonPickerLegacyCustomEvent<IIonPickerLegacyOverlayEventDetail>>();
  @Output() didPresent = new EventEmitter<IonPickerLegacyCustomEvent<void>>();
  @Output() willPresent = new EventEmitter<IonPickerLegacyCustomEvent<void>>();
  @Output() willDismiss = new EventEmitter<IonPickerLegacyCustomEvent<IIonPickerLegacyOverlayEventDetail>>();
  @Output() didDismiss = new EventEmitter<IonPickerLegacyCustomEvent<IIonPickerLegacyOverlayEventDetail>>();
  constructor(c: ChangeDetectorRef, r: ElementRef, protected z: NgZone) {
    c.detach();
    this.el = r.nativeElement;
  }
...
import type { IonPickerLegacyCustomEvent } from '@ionic/core/components';
...
export declare interface IonPickerLegacy extends Components.IonPickerLegacy {
   ...
   */
  ionPickerDidPresent: EventEmitter<IonPickerLegacyCustomEvent<void>>;
  /**
   * Emitted before the picker has presented.
   */
  ionPickerWillPresent: EventEmitter<IonPickerLegacyCustomEvent<void>>;
  /**
   * Emitted before the picker has dismissed.
   */
  ionPickerWillDismiss: EventEmitter<IonPickerLegacyCustomEvent<IIonPickerLegacyOverlayEventDetail>>;
  /**
   * Emitted after the picker has dismissed.
   */
  ionPickerDidDismiss: EventEmitter<IonPickerLegacyCustomEvent<IIonPickerLegacyOverlayEventDetail>>;
  /**
   * Emitted after the picker has presented.
Shorthand for ionPickerWillDismiss.
   */
  didPresent: EventEmitter<IonPickerLegacyCustomEvent<void>>;
  /**
   * Emitted before the picker has presented.
Shorthand for ionPickerWillPresent.
   */
  willPresent: EventEmitter<IonPickerLegacyCustomEvent<void>>;
  /**
   * Emitted before the picker has dismissed.
Shorthand for ionPickerWillDismiss.
   */
  willDismiss: EventEmitter<IonPickerLegacyCustomEvent<IIonPickerLegacyOverlayEventDetail>>;
  /**
   * Emitted after the picker has dismissed.
Shorthand for ionPickerDidDismiss.
   */
  didDismiss: EventEmitter<IonPickerLegacyCustomEvent<IIonPickerLegacyOverlayEventDetail>>;
}
