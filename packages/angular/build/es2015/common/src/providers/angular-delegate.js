...
let AngularDelegate = class AngularDelegate {
    ...
    create(environmentInjector, injector, elementReferenceKey, customInjector) {
        var _a;
        return new AngularFrameworkDelegate(environmentInjector, injector, this.applicationRef, this.zone, elementReferenceKey, (_a = this.config.useSetInputAPI) !== null && _a !== void 0 ? _a : false, customInjector);
    }
};
...
export const attachView = (zone, environmentInjector, injector, applicationRef, elRefMap, elEventsMap, container, component, params, cssClasses, elementReferenceKey, enableSignalsSupport, customInjector) => {
    ...
    const childInjector = Injector.create({
        providers,
        parent: customInjector !== null && customInjector !== void 0 ? customInjector : injector,
    });
    ...
    if (params) {
        ...
        if (enableSignalsSupport === true && componentRef.setInput !== undefined) {
            const { modal, popover } = params, otherParams = __rest(params, ["modal", "popover"]);
            /**
