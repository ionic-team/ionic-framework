(function(ionic) {
  ...
  .provider('$ionicPopup', function() {
    ...
    this.stackPushDelay = function(delay) {
      popupOptions.stackPushDelay = delay || popupOptions.stackPushDelay;
    };

    this.$get = ['$rootScope', '$q', '$document', '$compile', '$timeout', '$ionicTemplateLoader',
